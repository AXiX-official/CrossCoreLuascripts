...
function Refresh(_data,_elseData)
	...
	CSAPI.LoadImg(bg,"UIs/SignInContinue5/img_08_0" .. num1..".png",true,nil,true)
	local num2 = (_elseData and _elseData.isSpecial) and 2 or 1
	CSAPI.LoadImg(img,"UIs/SignInContinue5/img_07_0" .. num2..".png",true,nil,true)
	...
	if reward then
		...
		CSAPI.LoadImg(icon,"UIs/SignInContinue5/" .. iconName..".png",true,nil,true)
	end
end
