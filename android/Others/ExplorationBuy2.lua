...
function Refresh()
    ...
    SetContents(ExplorationState.Ex,txt_normalTitle,txt_normalPrice,txt_normalPriceType,txt_normalOver,btn_normalBuy,normal_VoucherBuy);
    SetContents(ExplorationState.Plus,txt_plusTitle,txt_plusPrice,txt_plusPriceType,txt_plusOver,btn_plusBuy,plus_VoucherBuy);
...
function SetContents(type,txt_title,txt_price,txt_priceType,txt_over,btn_buy,VoucherBuy)
