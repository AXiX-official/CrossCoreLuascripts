...
function LayoutCallBack(index)
    ...
    if lua then
        ...
        lua.Refresh(_data,"CfgRankReward")
    end
end

function Refresh(_data)
    cfgGlobalBoss = _data
    if cfgGlobalBoss and cfgGlobalBoss.rankRwdGroupId then
        cfg = Cfgs.cfgGlobalBossRanking:GetByID(cfgGlobalBoss.rankRwdGroupId)
        if cfg then
