...
---------------------------------------------
-- 技能基类
Buffer100700302 = oo.class(BuffBase)
function Buffer100700302:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 创建时
function Buffer100700302:OnCreate(caster, target)
	-- 8776
	...
	-- 100700302
	self:AddHp(BufferEffect[100700302], self.caster, self.card, nil, -math.floor(dmg10070*(1+0.02*c776*c777)))
	-- 100700304
