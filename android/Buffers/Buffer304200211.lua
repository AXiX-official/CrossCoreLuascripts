...
---------------------------------------------
-- 技能基类
Buffer304200211 = oo.class(BuffBase)
function Buffer304200211:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束2
function Buffer304200211:OnActionOver2(caster, target)
	-- 8063
	...
	-- 304200211
	self:OwnerAddBuff(BufferEffect[304200211], self.caster, self.card, nil, 304200201)
	-- 304200216
