...
---------------------------------------------
-- 技能基类
Buffer334301 = oo.class(BuffBase)
function Buffer334301:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer334301:OnRoundBegin(caster, target)
	-- 8420
	...
	-- 334301
	self:MissSurface2(BufferEffect[334301], self.caster, self.card, nil, 500)
	-- 334313
	self:AddBuff(BufferEffect[334313], self.caster, self.card, nil, 334306)
end
-- 回合结束时
function Buffer334301:OnRoundOver(caster, target)
	-- 334312
	...
	-- 334306
	self:MissSurface2(BufferEffect[334306], self.caster, self.card, nil, -500)
	-- 334314
