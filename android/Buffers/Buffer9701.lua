...
---------------------------------------------
-- 技能基类
Buffer9701 = oo.class(BuffBase)
function Buffer9701:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer9701:OnRemoveBuff(caster, target)
	-- 8458
...
-- 伤害前
function Buffer9701:OnBefourHurt(caster, target)
	-- 8063
	...
	-- 9701
	self:AddTempAttr(BufferEffect[9701], self.caster, self.caster, nil, "damage",-math.min(self.nCount*0.05+0.2,0.7))
end
