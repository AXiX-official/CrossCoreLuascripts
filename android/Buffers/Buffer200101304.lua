...
---------------------------------------------
-- 技能基类
Buffer200101304 = oo.class(BuffBase)
function Buffer200101304:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动开始
function Buffer200101304:OnActionBegin(caster, target)
	-- 8060
...
-- 回合开始时
function Buffer200101304:OnRoundBegin(caster, target)
	-- 8060
	if SkillJudger:CasterIsSelf(self, self.caster, target, true) then
	else
		return
...
-- 创建时
function Buffer200101304:OnCreate(caster, target)
	-- 200100203
	self:AddAttrPercent(BufferEffect[200100203], self.caster, target or self.owner, nil,"attack",0.20)
end
-- 攻击结束
function Buffer200101304:OnAttackOver(caster, target)
	-- 8063
