...
---------------------------------------------
-- 技能基类
Buffer2162 = oo.class(BuffBase)
function Buffer2162:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer2162:OnRemoveBuff(caster, target)
	-- 8063
...
-- 创建时
function Buffer2162:OnCreate(caster, target)
	-- 2116
