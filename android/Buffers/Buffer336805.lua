...
---------------------------------------------
-- 技能基类
Buffer336805 = oo.class(BuffBase)
function Buffer336805:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer336805:OnRemoveBuff(caster, target)
	-- 336807
	self:DelValue(BufferEffect[336807], self.caster, self.card, nil, "gc")
end
-- 伤害前
function Buffer336805:OnBefourHurt(caster, target)
	-- 336806
	...
	-- 336805
	self:AddTempAttr(BufferEffect[336805], self.caster, self.card, nil, "damage",0.03*gc)
end
-- 创建时
function Buffer336805:OnCreate(caster, target)
	-- 8060
