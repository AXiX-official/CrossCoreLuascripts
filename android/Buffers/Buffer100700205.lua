...
---------------------------------------------
-- 技能基类
Buffer100700205 = oo.class(BuffBase)
function Buffer100700205:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer100700205:OnActionOver(caster, target)
	-- 8063
	...
	-- 100700205
	self:AddValue(BufferEffect[100700205], self.caster, self.card, nil, "dmg10070",0.2*c778)
end
-- 创建时
function Buffer100700205:OnCreate(caster, target)
	-- 8418
