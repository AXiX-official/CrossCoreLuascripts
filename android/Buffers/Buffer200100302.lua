...
---------------------------------------------
-- 技能基类
Buffer200100302 = oo.class(BuffBase)
function Buffer200100302:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer200100302:OnRoundBegin(caster, target)
	-- 8060
...
-- 创建时
function Buffer200100302:OnCreate(caster, target)
	-- 200100202
	self:AddAttrPercent(BufferEffect[200100202], self.caster, target or self.owner, nil,"attack",0.15)
end
-- 攻击结束
function Buffer200100302:OnAttackOver(caster, target)
	-- 8063
