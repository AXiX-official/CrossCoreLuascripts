...
---------------------------------------------
-- 技能基类
Buffer334305 = oo.class(BuffBase)
function Buffer334305:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer334305:OnRoundBegin(caster, target)
	-- 8420
	...
	-- 334305
	self:MissSurface2(BufferEffect[334305], self.caster, self.card, nil, 2500)
	-- 334313
	self:AddBuff(BufferEffect[334313], self.caster, self.card, nil, 334306)
end
-- 回合结束时
function Buffer334305:OnRoundOver(caster, target)
	-- 334312
	...
	-- 334310
	self:MissSurface2(BufferEffect[334310], self.caster, self.card, nil, -2500)
	-- 334314
