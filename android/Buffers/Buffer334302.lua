...
---------------------------------------------
-- 技能基类
Buffer334302 = oo.class(BuffBase)
function Buffer334302:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer334302:OnRoundBegin(caster, target)
	-- 8420
	...
	-- 334302
	self:MissSurface2(BufferEffect[334302], self.caster, self.card, nil, 1000)
	-- 334313
	self:AddBuff(BufferEffect[334313], self.caster, self.card, nil, 334306)
end
-- 回合结束时
function Buffer334302:OnRoundOver(caster, target)
	-- 334312
	...
	-- 334307
	self:MissSurface2(BufferEffect[334307], self.caster, self.card, nil, -1000)
	-- 334314
