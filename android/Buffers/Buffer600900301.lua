...
---------------------------------------------
-- 技能基类
Buffer600900301 = oo.class(BuffBase)
function Buffer600900301:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer600900301:OnRemoveBuff(caster, target)
	-- 600900302
	self:ChangeSkill(BufferEffect[600900302], self.caster, self.card, nil, 1,600900101)
end
-- 创建时
function Buffer600900301:OnCreate(caster, target)
	-- 600900301
