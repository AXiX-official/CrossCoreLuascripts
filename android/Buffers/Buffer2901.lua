...
---------------------------------------------
-- 技能基类
Buffer2901 = oo.class(BuffBase)
function Buffer2901:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 伤害前
function Buffer2901:OnBefourHurt(caster, target)
	-- 8063
...
-- 创建时
function Buffer2901:OnCreate(caster, target)
	-- 2901
	self:AddReduceShield(BufferEffect[2901], self.caster, target or self.owner, nil,0.2,1,0.1)
	-- 8462
