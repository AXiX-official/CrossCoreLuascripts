...
---------------------------------------------
-- 技能基类
Buffer702400204 = oo.class(BuffBase)
function Buffer702400204:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer702400204:OnActionOver(caster, target)
	-- 8063
...
-- 创建时
function Buffer702400204:OnCreate(caster, target)
	-- 4904
