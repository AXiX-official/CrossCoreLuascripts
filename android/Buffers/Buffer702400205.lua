...
---------------------------------------------
-- 技能基类
Buffer702400205 = oo.class(BuffBase)
function Buffer702400205:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 行动结束
function Buffer702400205:OnActionOver(caster, target)
	-- 8063
	...
	-- 702400203
	self:OwnerHitAddBuff(BufferEffect[702400203], self.caster, self.caster, nil, 2000+c77*200,3005,1)
	-- 8478
...
-- 创建时
function Buffer702400205:OnCreate(caster, target)
	-- 4904
