...
---------------------------------------------
-- 技能基类
Buffer2190 = oo.class(BuffBase)
function Buffer2190:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer2190:OnRemoveBuff(caster, target)
	-- 8218
...
-- 创建时
function Buffer2190:OnCreate(caster, target)
	-- 2119
