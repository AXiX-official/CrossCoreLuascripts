...
---------------------------------------------
-- 技能基类
Buffer100200205 = oo.class(BuffBase)
function Buffer100200205:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 死亡时
function Buffer100200205:OnDeath(caster, target)
	-- 8070
...
-- 行动结束
function Buffer100200205:OnActionOver(caster, target)
	-- 8063
	...
	-- 100200205
	self:AddHp(BufferEffect[100200205], self.caster, self.card, nil, math.floor(c14*0.70))
end
