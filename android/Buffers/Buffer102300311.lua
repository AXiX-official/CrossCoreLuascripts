...
---------------------------------------------
-- 技能基类
Buffer102300311 = oo.class(BuffBase)
function Buffer102300311:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer102300311:OnRemoveBuff(caster, target)
...
-- 行动结束
function Buffer102300311:OnActionOver(caster, target)
