...
function Buffer910800502:OnCreate(caster, target)
	-- 910800501
	self:AddAttrPercent(BufferEffect[910800501], self.caster, target or self.owner, nil,"attack",10*self.nCount)
	-- 910800502
	self:AddAttrPercent(BufferEffect[910800502], self.caster, target or self.owner, nil,"defense",10*self.nCount)
	-- 910800503
