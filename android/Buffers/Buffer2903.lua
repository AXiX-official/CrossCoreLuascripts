...
---------------------------------------------
-- 技能基类
Buffer2903 = oo.class(BuffBase)
function Buffer2903:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 伤害前
function Buffer2903:OnBefourHurt(caster, target)
	-- 8063
...
-- 创建时
function Buffer2903:OnCreate(caster, target)
	-- 2903
	self:AddReduceShield(BufferEffect[2903], self.caster, target or self.owner, nil,0.4,1,0.1)
	-- 8462
