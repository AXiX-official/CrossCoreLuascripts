local conf = {
	...
	["sheetname"] = '主线',
	["types"] = {
'int','int','string','int','string','int','int','int[]','string','string','string','int','int','int','int','int','int[]','int','int','int','string','string','string','string','json','int[]','string','string','string','string','float','int','int','int','string[]','string[]','string[]','string','string','int'
},
	["names"] = {
'id','key','chapter','type','name','pos','open_tips','conditions','path','fatherView','fatherDesc','index','group','fade','activeId','turnNum','openTime','dailyEnumID','count','cd','lock_desc','desc','icon','descImg','fallRewards','starRewardID','mName','eName','sBg','bg','bgPosZ','multiId','sOpen','preSection','passDesc','nextOpenDesc','diffPassDesc','descKey','bgm','story'
},
	["data"] = {
