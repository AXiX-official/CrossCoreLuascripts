local conf = {
	...
	["sheetname"] = '多人插图',
	["types"] = {
'int','string','int','string','int','string','string','int','string','string','string','string','float[]','string','float[]','bool','int'
},
	["names"] = {
'id','key','itemId','sName','sort','sStart','sEnd','theme_type','img','img_replace','icon','get_txt','imgPos','l2dName','l2dPos','show','shopId'
},
	["data"] = {
