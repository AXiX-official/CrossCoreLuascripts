local conf = {
	...
	["sheetname"] = '道具组奖励表',
	["types"] = {
'int','string','table#15','int','int[]','int','int[]','int','int','int','bool','bool','int','int','int','int','int','int'
},
	["names"] = {
'id','name','pool','index','rounds','rewardLevel','reward','Languageid','rewardnum','weight','isInfinite','iskeyreward','controlType','controlGroup','controlLimit','controlMax','isShow','countMax'
},
	["data"] = {
{'1',	'回归道具池',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	''},
{'1',	'',	'',	'1',	'1',	'',	'10033,5',	'',	'2',	'70',	'',	'',	'',	'',	'',	'',	'',	''},
