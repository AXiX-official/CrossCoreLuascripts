...
---------------------------------------------
-- 技能基类
Skill304900104 = oo.class(SkillBase)
function Skill304900104:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill304900104:DoSkill(caster, target, data)
	-- 11001
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11001], caster, target, data, 1,1)
end
-- 行动结束
function Skill304900104:OnActionOver(caster, target, data)
	-- 8060
