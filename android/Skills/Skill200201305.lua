...
---------------------------------------------
-- 技能基类
Skill200201305 = oo.class(SkillBase)
function Skill200201305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill200201305:DoSkill(caster, target, data)
	-- 200200305
...
-- 行动结束
function Skill200201305:OnActionOver(caster, target, data)
	-- 8060
