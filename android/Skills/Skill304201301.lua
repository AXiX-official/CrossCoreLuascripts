...
---------------------------------------------
-- 技能基类
Skill304201301 = oo.class(SkillBase)
function Skill304201301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill304201301:DoSkill(caster, target, data)
	-- 12006
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12006], caster, target, data, 0.167,6)
end
-- 攻击结束
function Skill304201301:OnAttackOver(caster, target, data)
	-- 8060
