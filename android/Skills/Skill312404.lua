...
---------------------------------------------
-- 技能基类
Skill312404 = oo.class(SkillBase)
function Skill312404:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill312404:OnActionOver(caster, target, data)
	-- 8202
	...
	if self:Rand(7500) then
		self:AddBuff(SkillEffect[312404], caster, self.card, data, 6500+count54)
	end
end
