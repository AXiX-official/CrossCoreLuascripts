...
---------------------------------------------
-- 技能基类
Skill100301301 = oo.class(SkillBase)
function Skill100301301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100301301:DoSkill(caster, target, data)
	-- 11051
...
-- 行动结束
function Skill100301301:OnActionOver(caster, target, data)
	-- 8060
