...
---------------------------------------------
-- 技能基类
Skill300201305 = oo.class(SkillBase)
function Skill300201305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill300201305:DoSkill(caster, target, data)
	-- 11051
...
-- 伤害前
function Skill300201305:OnBefourHurt(caster, target, data)
	-- 8060
