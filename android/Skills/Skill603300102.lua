...
---------------------------------------------
-- 技能基类
Skill603300102 = oo.class(SkillBase)
function Skill603300102:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill603300102:DoSkill(caster, target, data)
	-- 12002
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12002], caster, target, data, 0.5,2)
end
-- 伤害前
function Skill603300102:OnBefourHurt(caster, target, data)
	-- 8060
...
-- 特殊入场时(复活，召唤，合体)
function Skill603300102:OnBornSpecial(caster, target, data)
	-- 8166
