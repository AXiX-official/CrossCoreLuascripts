...
---------------------------------------------
-- 技能基类
Skill102101305 = oo.class(SkillBase)
function Skill102101305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill102101305:DoSkill(caster, target, data)
	-- 11121
...
-- 行动结束
function Skill102101305:OnActionOver(caster, target, data)
	-- 8060
