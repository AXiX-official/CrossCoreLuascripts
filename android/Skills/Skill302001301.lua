...
---------------------------------------------
-- 技能基类
Skill302001301 = oo.class(SkillBase)
function Skill302001301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill302001301:DoSkill(caster, target, data)
	-- 11004
...
-- 伤害前
function Skill302001301:OnBefourHurt(caster, target, data)
	-- 8060
