...
---------------------------------------------
-- 技能基类
Skill703300302 = oo.class(SkillBase)
function Skill703300302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill703300302:DoSkill(caster, target, data)
	-- 12005
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12005], caster, target, data, 0.2,5)
end
-- 行动结束2
function Skill703300302:OnActionOver2(caster, target, data)
	-- 8060
...
-- 攻击结束
function Skill703300302:OnAttackOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
