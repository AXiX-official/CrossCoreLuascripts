...
---------------------------------------------
-- 技能基类
Skill603301304 = oo.class(SkillBase)
function Skill603301304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill603301304:DoSkill(caster, target, data)
	-- 12004
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 伤害前
function Skill603301304:OnBefourHurt(caster, target, data)
	-- 8060
...
function Skill603301304:tFunc_603300115_603300105(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill603301304:tFunc_603300115_603300112(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
