...
---------------------------------------------
-- 技能基类
Skill703101301 = oo.class(SkillBase)
function Skill703101301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill703101301:DoSkill(caster, target, data)
	-- 12007
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12007], caster, target, data, 0.143,7)
end
-- 伤害后
function Skill703101301:OnAfterHurt(caster, target, data)
	-- 703100411
	self:tFunc_703100411_703100301(caster, target, data)
	self:tFunc_703100411_703100311(caster, target, data)
end
-- 行动结束2
function Skill703101301:OnActionOver2(caster, target, data)
	-- 8723
...
function Skill703101301:tFunc_703100411_703100311(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
