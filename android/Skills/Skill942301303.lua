...
---------------------------------------------
-- 技能基类
Skill942301303 = oo.class(SkillBase)
function Skill942301303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill942301303:DoSkill(caster, target, data)
	-- 704301303
	self.order = self.order + 1
	self:AddBuff(SkillEffect[704301303], caster, target, data, 704301303)
end
-- 伤害后
function Skill942301303:OnAfterHurt(caster, target, data)
	-- 8063
