...
---------------------------------------------
-- 技能基类
Skill321202 = oo.class(SkillBase)
function Skill321202:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill321202:OnAfterHurt(caster, target, data)
	-- 8071
	...
	-- 321202
	self:AddHp(SkillEffect[321202], caster, caster, data, -count21*0.2)
end
