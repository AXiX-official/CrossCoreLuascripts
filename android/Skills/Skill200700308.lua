...
---------------------------------------------
-- 技能基类
Skill200700308 = oo.class(SkillBase)
function Skill200700308:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill200700308:DoSkill(caster, target, data)
...
-- 伤害后
function Skill200700308:OnAfterHurt(caster, target, data)
...
-- 治疗时
function Skill200700308:OnCure(caster, target, data)
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	end
