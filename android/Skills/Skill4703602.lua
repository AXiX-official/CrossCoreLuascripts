...
-- 入场时
function Skill4703602:OnBorn(caster, target, data)
	-- 8060
	...
	for i,target in ipairs(targets) do
		self:AddBuff(SkillEffect[4703622], caster, target, data, 4703622)
	end
end
-- 特殊入场时(复活，召唤，合体)
function Skill4703602:OnBornSpecial(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 死亡时
function Skill4703602:OnDeath(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
