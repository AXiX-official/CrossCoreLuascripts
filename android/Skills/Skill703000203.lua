...
---------------------------------------------
-- 技能基类
Skill703000203 = oo.class(SkillBase)
function Skill703000203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill703000203:DoSkill(caster, target, data)
	-- 11091
...
-- 攻击结束
function Skill703000203:OnAttackOver(caster, target, data)
	-- 8063
	...
	-- 4702808
	self:AddBuff(SkillEffect[4702808], caster, self.card, data, 4702806)
end
