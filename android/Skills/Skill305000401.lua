...
-- 行动结束2
function Skill305000401:OnActionOver2(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill305000401:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 回合开始时
function Skill305000401:OnRoundBegin(caster, target, data)
	-- 305000320
