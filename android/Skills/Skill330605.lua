...
---------------------------------------------
-- 技能基类
Skill330605 = oo.class(SkillBase)
function Skill330605:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束2
function Skill330605:OnActionOver2(caster, target, data)
	-- 8060
	...
	for i,target in ipairs(targets) do
		self:AddProgress(SkillEffect[330605], caster, target, data, 300)
	end
	-- 330611
