...
---------------------------------------------
-- 技能基类
Skill326904 = oo.class(SkillBase)
function Skill326904:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill326904:OnDeath(caster, target, data)
	-- 8070
...
-- 回合开始时
function Skill326904:OnRoundBegin(caster, target, data)
	-- 8060
