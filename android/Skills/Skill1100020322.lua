-- 治疗时获得随机强化效果（攻击+20％，防御+20％，暴击+20％，机动性+40，受治疗效果+40％）
-- 本文件由工具自动生成,请不要直接编辑本文件
---------------------------------------------
-- 技能基类
Skill1100020322 = oo.class(SkillBase)
function Skill1100020322:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 治疗时
function Skill1100020322:OnCure(caster, target, data)
	-- 8060
