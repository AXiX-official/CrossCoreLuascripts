...
---------------------------------------------
-- 技能基类
Skill4304203 = oo.class(SkillBase)
function Skill4304203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill4304203:OnAttackOver(caster, target, data)
	-- 8060
	...
	if self:Rand(3000) then
		self:AddNp(SkillEffect[4304203], caster, target, data, -5)
		-- 8060
		if SkillJudger:CasterIsSelf(self, caster, target, true) then
		else
			return
...
-- 行动结束
function Skill4304203:OnActionOver(caster, target, data)
	-- 8166
