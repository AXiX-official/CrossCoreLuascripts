...
---------------------------------------------
-- 技能基类
Skill312402 = oo.class(SkillBase)
function Skill312402:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill312402:OnActionOver(caster, target, data)
	-- 8202
	...
	if self:Rand(4500) then
		self:AddBuff(SkillEffect[312402], caster, self.card, data, 6500+count54)
	end
end
