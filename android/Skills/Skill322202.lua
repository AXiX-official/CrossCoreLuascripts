...
---------------------------------------------
-- 技能基类
Skill322202 = oo.class(SkillBase)
function Skill322202:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill322202:OnDeath(caster, target, data)
	-- 8060
	...
	-- 322202
	self:OwnerAddBuffCount(SkillEffect[322202], caster, self.card, data, 322202,1,5)
end
