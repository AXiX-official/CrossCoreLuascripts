...
function Skill4302603:OnBorn(caster, target, data)
	-- 4302633
	self:tFunc_4302633_4302603(caster, target, data)
	self:tFunc_4302633_4302621(caster, target, data)
	self:tFunc_4302633_4302622(caster, target, data)
	self:tFunc_4302633_4302623(caster, target, data)
	self:tFunc_4302633_4302624(caster, target, data)
end
-- 回合开始时
function Skill4302603:OnRoundBegin(caster, target, data)
	-- 8728
...
-- 伤害前
function Skill4302603:OnBefourHurt(caster, target, data)
	-- 8062
	...
	-- 4302653
	self:AddTempAttr(SkillEffect[4302653], caster, target, data, "bedamage",count730*0.03)
end
function Skill4302603:tFunc_4302633_4302603(caster, target, data)
	-- 8060
	...
	-- 4302603
	self:CallSkillEx(SkillEffect[4302603], caster, self.card, data, 302600402)
end
function Skill4302603:tFunc_4302633_4302622(caster, target, data)
	-- 8274
...
function Skill4302603:tFunc_4302633_4302623(caster, target, data)
	-- 8273
...
function Skill4302603:tFunc_4302633_4302621(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4302603:tFunc_4302633_4302624(caster, target, data)
	-- 8271
