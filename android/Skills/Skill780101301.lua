...
---------------------------------------------
-- 技能基类
Skill780101301 = oo.class(SkillBase)
function Skill780101301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill780101301:DoSkill(caster, target, data)
	-- 12004
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 伤害前
function Skill780101301:OnBefourHurt(caster, target, data)
	-- 8060
...
function Skill780101301:tFunc_603300114_603300111(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill780101301:tFunc_603300114_603300104(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
