...
---------------------------------------------
-- 技能基类
Skill4501804 = oo.class(SkillBase)
function Skill4501804:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4501804:OnBorn(caster, target, data)
	-- 8384
...
function Skill4501804:tFunc_8384_8374(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4501804:tFunc_8383_8353(caster, target, data)
	-- 8070
...
function Skill4501804:tFunc_8382_8373(caster, target, data)
	-- 8070
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4501804:tFunc_8383_8352(caster, target, data)
	-- 8070
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4501804:tFunc_8384_8315(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4501804:tFunc_8382_8372(caster, target, data)
	-- 8070
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
