...
---------------------------------------------
-- 技能基类
Skill803500302 = oo.class(SkillBase)
function Skill803500302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill803500302:DoSkill(caster, target, data)
	-- 12006
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12006], caster, target, data, 0.167,6)
end
-- 伤害前
function Skill803500302:OnBefourHurt(caster, target, data)
	-- 8060
...
-- 死亡时
function Skill803500302:OnDeath(caster, target, data)
	-- 8070
