...
---------------------------------------------
-- 技能基类
Skill913200701 = oo.class(SkillBase)
function Skill913200701:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
function Skill913200701:CanSummon()
...
-- 执行技能
function Skill913200701:DoSkill(caster, target, data)
	-- 913200302
...
-- 行动结束
function Skill913200701:OnActionOver(caster, target, data)
	-- 8060
