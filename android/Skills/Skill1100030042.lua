...
function Skill1100030042:OnCure(caster, target, data)
	...
	-- 1100030045
	self:OwnerAddBuffCount(SkillEffect[1100030045], caster, self.card, data, 1100030042,1,50)
end
-- 行动结束
...
function Skill1100030042:tFunc_11000300402_1100030042(caster, target, data)
	...
	-- 1100030042
	self:OwnerAddBuffCount(SkillEffect[1100030042], caster, self.card, data, 1100030042,1,50)
end
