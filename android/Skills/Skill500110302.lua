...
---------------------------------------------
-- 技能基类
Skill500110302 = oo.class(SkillBase)
function Skill500110302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill500110302:DoSkill(caster, target, data)
	-- 12801
...
-- 攻击结束
function Skill500110302:OnAttackOver(caster, target, data)
	-- 8060
