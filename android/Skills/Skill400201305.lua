...
---------------------------------------------
-- 技能基类
Skill400201305 = oo.class(SkillBase)
function Skill400201305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill400201305:DoSkill(caster, target, data)
	-- 12026
...
-- 伤害前
function Skill400201305:OnBefourHurt(caster, target, data)
	-- 8060
