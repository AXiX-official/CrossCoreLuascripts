...
---------------------------------------------
-- 技能基类
Skill4301205 = oo.class(SkillBase)
function Skill4301205:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill4301205:OnActionOver(caster, target, data)
	-- 8063
	...
	-- 4301205
	self:OwnerAddBuffCount(SkillEffect[4301205], caster, self.card, data, 4301205,1,5)
	-- 4301206
