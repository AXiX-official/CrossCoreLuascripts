...
function Skill300401305:OnAttackOver(caster, target, data)
	-- 300401309
	self:tFunc_300401309_300400307(caster, target, data)
	self:tFunc_300401309_300400308(caster, target, data)
end
function Skill300401305:tFunc_300401309_300400307(caster, target, data)
	-- 8060
...
function Skill300401305:tFunc_300401309_300400308(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
