...
---------------------------------------------
-- 技能基类
Skill322103 = oo.class(SkillBase)
function Skill322103:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill322103:OnBefourHurt(caster, target, data)
	-- 8060
	...
	-- 322103
	self:AddTempAttr(SkillEffect[322103], caster, self.card, data, "damage",0.30)
end
