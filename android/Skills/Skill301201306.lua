...
---------------------------------------------
-- 技能基类
Skill301201306 = oo.class(SkillBase)
function Skill301201306:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill301201306:DoSkill(caster, target, data)
...
-- 伤害前
function Skill301201306:OnBefourHurt(caster, target, data)
