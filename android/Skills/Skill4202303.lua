...
---------------------------------------------
-- 技能基类
Skill4202303 = oo.class(SkillBase)
function Skill4202303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill4202303:OnActionOver(caster, target, data)
	-- 8060
...
-- 攻击结束2
function Skill4202303:OnAttackOver2(caster, target, data)
	-- 8071
