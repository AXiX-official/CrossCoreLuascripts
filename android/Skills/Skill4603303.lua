...
---------------------------------------------
-- 技能基类
Skill4603303 = oo.class(SkillBase)
function Skill4603303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动开始
function Skill4603303:OnActionBegin(caster, target, data)
	-- 8060
...
-- 特殊入场时(复活，召唤，合体)
function Skill4603303:OnBornSpecial(caster, target, data)
	-- 8166
...
-- 伤害前
function Skill4603303:OnBefourHurt(caster, target, data)
	-- 4603342
	self:tFunc_4603342_4603312(caster, target, data)
	self:tFunc_4603342_4603315(caster, target, data)
end
function Skill4603303:tFunc_4603342_4603315(caster, target, data)
	-- 8166
	if SkillJudger:CasterIsOwnSummon(self, caster, target, true) then
	else
		return
...
function Skill4603303:tFunc_4603342_4603312(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
