...
function Skill4400605:OnBefourCritHurt(caster, target, data)
	-- 8062
	...
	-- 4400615
	self:AddTempAttr(SkillEffect[4400615], caster, caster, data, "crit",0.005*math.max(count7-count8,0))
end
-- 特殊入场时(复活，召唤，合体)
function Skill4400605:OnBornSpecial(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
