...
---------------------------------------------
-- 技能基类
Skill321201 = oo.class(SkillBase)
function Skill321201:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill321201:OnAfterHurt(caster, target, data)
	-- 8071
	...
	-- 321201
	self:AddHp(SkillEffect[321201], caster, caster, data, -count21*0.1)
end
