...
---------------------------------------------
-- 技能基类
Skill700510304 = oo.class(SkillBase)
function Skill700510304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill700510304:DoSkill(caster, target, data)
	-- 12001
...
function Skill700510304:tFunc_700510301_700510303(caster, target, data)
	-- 700510303
	self.order = self.order + 1
	self:BeatAgain(SkillEffect[700510303], caster, target, data, nil)
end
function Skill700510304:tFunc_700510301_700510302(caster, target, data)
	-- 8467
	local count67 = SkillApi:GetAttr(self, caster, target,2,"hp")
	-- 700510302
	self.order = self.order + 1
