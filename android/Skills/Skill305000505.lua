...
---------------------------------------------
-- 技能基类
Skill305000505 = oo.class(SkillBase)
function Skill305000505:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill305000505:DoSkill(caster, target, data)
	-- 11503
...
-- 行动结束
function Skill305000505:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
