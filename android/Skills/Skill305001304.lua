...
-- 伤害前
function Skill305001304:OnBefourHurt(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill305001304:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 伤害后
function Skill305001304:OnAfterHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	...
	-- 305000504
	self:LimitDamage(SkillEffect[305000504], caster, target, data, 0.05,7)
end
