-- 治疗时获得随机强化效果（攻击+10％，防御+10％，暴击+10％，机动性+20，受治疗效果+20％)持续2回合
-- 本文件由工具自动生成,请不要直接编辑本文件
---------------------------------------------
-- 技能基类
Skill1100020320 = oo.class(SkillBase)
function Skill1100020320:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 治疗时
function Skill1100020320:OnCure(caster, target, data)
	-- 8060
