...
---------------------------------------------
-- 技能基类
Skill313102 = oo.class(SkillBase)
function Skill313102:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill313102:OnBorn(caster, target, data)
	-- 8381
...
-- 伤害后
function Skill313102:OnAfterHurt(caster, target, data)
	-- 8070
...
-- 治疗时
function Skill313102:OnCure(caster, target, data)
	-- 8383
	self:tFunc_8383_8352(caster, target, data)
	self:tFunc_8383_8353(caster, target, data)
end
function Skill313102:tFunc_8381_8371(caster, target, data)
	-- 8060
...
function Skill313102:tFunc_8381_8315(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill313102:tFunc_8383_8353(caster, target, data)
	-- 8070
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
...
function Skill313102:tFunc_8383_8352(caster, target, data)
	-- 8070
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
...
function Skill313102:tFunc_8381_8314(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
