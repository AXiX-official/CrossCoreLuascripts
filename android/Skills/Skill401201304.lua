...
---------------------------------------------
-- 技能基类
Skill401201304 = oo.class(SkillBase)
function Skill401201304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill401201304:DoSkill(caster, target, data)
	-- 12205
...
-- 伤害前
function Skill401201304:OnBefourHurt(caster, target, data)
	-- 8060
...
-- 行动开始
function Skill401201304:OnActionBegin(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
