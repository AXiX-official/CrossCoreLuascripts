...
---------------------------------------------
-- 技能基类
Skill503000305 = oo.class(SkillBase)
function Skill503000305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill503000305:DoSkill(caster, target, data)
	-- 11005
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11005], caster, target, data, 0.2,5)
end
-- 暴击伤害前(OnBefourHurt之前)
function Skill503000305:OnBefourCritHurt(caster, target, data)
	-- 8060
