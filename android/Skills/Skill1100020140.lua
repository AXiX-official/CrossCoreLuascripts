...
---------------------------------------------
-- 技能基类
Skill1100020140 = oo.class(SkillBase)
function Skill1100020140:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合开始时
function Skill1100020140:OnRoundBegin(caster, target, data)
	-- 8060
	...
	elseif 5 == r then
		...
		-- 1100020145
		self:AddBuff(SkillEffect[1100020145], caster, self.card, data, 1100020145)
	elseif 6 == r then
		-- 8060
		if SkillJudger:CasterIsSelf(self, caster, target, true) then
		else
	...
	elseif 8 == r then
		...
		-- 1100020148
		self:AddBuff(SkillEffect[1100020148], caster, self.card, data, 1100020148)
	elseif 9 == r then
		-- 8060
		if SkillJudger:CasterIsSelf(self, caster, target, true) then
		else
