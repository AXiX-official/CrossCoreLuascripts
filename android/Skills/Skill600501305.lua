...
---------------------------------------------
-- 技能基类
Skill600501305 = oo.class(SkillBase)
function Skill600501305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600501305:DoSkill(caster, target, data)
	-- 11111
...
-- 行动开始
function Skill600501305:OnActionBegin(caster, target, data)
	-- 8060
...
-- 行动结束2
function Skill600501305:OnActionOver2(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 加buff时
function Skill600501305:OnAddBuff(caster, target, data, buffer)
	-- 8063
