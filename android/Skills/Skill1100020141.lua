...
---------------------------------------------
-- 技能基类
Skill1100020141 = oo.class(SkillBase)
function Skill1100020141:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合开始时
function Skill1100020141:OnRoundBegin(caster, target, data)
	-- 8060
