...
---------------------------------------------
-- 技能基类
Skill4603005 = oo.class(SkillBase)
function Skill4603005:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill4603005:OnActionOver(caster, target, data)
	-- 4603003
	self:tFunc_4603003_4603023(caster, target, data)
	self:tFunc_4603003_4603013(caster, target, data)
end
function Skill4603005:tFunc_4603003_4603013(caster, target, data)
	-- 8061
...
function Skill4603005:tFunc_4603003_4603023(caster, target, data)
	-- 8064
