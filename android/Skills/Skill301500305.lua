...
---------------------------------------------
-- 技能基类
Skill301500305 = oo.class(SkillBase)
function Skill301500305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill301500305:DoSkill(caster, target, data)
	-- 12701
...
-- 攻击结束
function Skill301500305:OnAttackOver(caster, target, data)
	-- 8060
