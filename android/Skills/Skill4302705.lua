...
---------------------------------------------
-- 技能基类
Skill4302705 = oo.class(SkillBase)
function Skill4302705:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 加buff时
function Skill4302705:OnAddBuff(caster, target, data, buffer)
	-- 8060
	...
	-- 4302705
	self:OwnerAddBuffCount(SkillEffect[4302705], caster, target, data, 4302705,1,1)
end
-- 暴击伤害前(OnBefourHurt之前)
function Skill4302705:OnBefourCritHurt(caster, target, data)
	-- 4302711
