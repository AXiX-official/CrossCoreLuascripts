...
---------------------------------------------
-- 技能基类
Skill801400102 = oo.class(SkillBase)
function Skill801400102:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill801400102:DoSkill(caster, target, data)
	-- 12001
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12001], caster, target, data, 1,1)
end
-- 行动结束
function Skill801400102:OnActionOver(caster, target, data)
	-- 8060
