...
---------------------------------------------
-- 技能基类
Skill4101904 = oo.class(SkillBase)
function Skill4101904:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4101904:OnBorn(caster, target, data)
	-- 8060
	...
	-- 4101904
	self:SetShareDamage(SkillEffect[4101904], caster, self.card, data, 0.35)
end
-- 伤害后
function Skill4101904:OnAfterHurt(caster, target, data)
	-- 8063
