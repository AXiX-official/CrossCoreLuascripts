...
---------------------------------------------
-- 技能基类
Skill400700203 = oo.class(SkillBase)
function Skill400700203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill400700203:DoSkill(caster, target, data)
	-- 11001
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11001], caster, target, data, 1,1)
end
-- 行动结束
function Skill400700203:OnActionOver(caster, target, data)
	-- 8060
...
-- 伤害后
function Skill400700203:OnAfterHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
