-- 肉鸽虫洞阵营同调角色不再虚弱，同调角色后伤害提高80%，使用大招技能血量减少10%
-- 本文件由工具自动生成,请不要直接编辑本文件
---------------------------------------------
-- 技能基类
Skill1100050032 = oo.class(SkillBase)
function Skill1100050032:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill1100050032:OnBefourHurt(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill1100050032:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 入场时
function Skill1100050032:OnBorn(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
