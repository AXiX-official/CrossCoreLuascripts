...
-- 伤害后
function Skill703100305:OnAfterHurt(caster, target, data)
	-- 703100413
	self:tFunc_703100413_703100303(caster, target, data)
	self:tFunc_703100413_703100313(caster, target, data)
end
function Skill703100305:tFunc_703100413_703100303(caster, target, data)
	-- 8060
...
function Skill703100305:tFunc_703100413_703100313(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
