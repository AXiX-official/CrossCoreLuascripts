...
---------------------------------------------
-- 技能基类
Skill303101305 = oo.class(SkillBase)
function Skill303101305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill303101305:DoSkill(caster, target, data)
	-- 12705
...
-- 攻击结束
function Skill303101305:OnAttackOver(caster, target, data)
	-- 8060
