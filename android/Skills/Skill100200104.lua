...
---------------------------------------------
-- 技能基类
Skill100200104 = oo.class(SkillBase)
function Skill100200104:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100200104:DoSkill(caster, target, data)
	-- 11002
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11002], caster, target, data, 0.5,2)
end
-- 攻击结束
function Skill100200104:OnAttackOver(caster, target, data)
	-- 8060
