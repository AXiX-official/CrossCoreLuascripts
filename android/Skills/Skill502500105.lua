...
---------------------------------------------
-- 技能基类
Skill502500105 = oo.class(SkillBase)
function Skill502500105:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill502500105:DoSkill(caster, target, data)
	-- 11002
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11002], caster, target, data, 0.5,2)
end
-- 伤害前
function Skill502500105:OnBefourHurt(caster, target, data)
	-- 8060
