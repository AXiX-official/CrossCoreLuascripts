...
---------------------------------------------
-- 技能基类
Skill4603215 = oo.class(SkillBase)
function Skill4603215:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill4603215:OnRoundOver(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill4603215:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
