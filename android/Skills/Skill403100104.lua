...
---------------------------------------------
-- 技能基类
Skill403100104 = oo.class(SkillBase)
function Skill403100104:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill403100104:DoSkill(caster, target, data)
	-- 12002
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12002], caster, target, data, 0.5,2)
end
-- 伤害前
function Skill403100104:OnBefourHurt(caster, target, data)
	-- 8060
