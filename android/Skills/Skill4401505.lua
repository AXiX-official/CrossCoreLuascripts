...
---------------------------------------------
-- 技能基类
Skill4401505 = oo.class(SkillBase)
function Skill4401505:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束2
function Skill4401505:OnActionOver2(caster, target, data)
	-- 8063
	...
	-- 4401505
	self:BeatBack(SkillEffect[4401505], caster, self.card, data, 401500405,5)
end
