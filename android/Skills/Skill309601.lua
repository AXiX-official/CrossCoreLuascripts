...
---------------------------------------------
-- 技能基类
Skill309601 = oo.class(SkillBase)
function Skill309601:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill309601:OnAfterHurt(caster, target, data)
	-- 8060
	...
	-- 309601
	self:LimitDamage(SkillEffect[309601], caster, target, data, 0.06,0.6)
	-- 92018
