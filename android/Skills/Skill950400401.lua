...
---------------------------------------------
-- 技能基类
Skill950400401 = oo.class(SkillBase)
function Skill950400401:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill950400401:DoSkill(caster, target, data)
	-- 11012
...
-- 攻击结束
function Skill950400401:OnAttackOver(caster, target, data)
	-- 8200
