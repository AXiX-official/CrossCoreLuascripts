...
---------------------------------------------
-- 技能基类
Skill700511305 = oo.class(SkillBase)
function Skill700511305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill700511305:DoSkill(caster, target, data)
	-- 12001
...
function Skill700511305:tFunc_700511301_700511302(caster, target, data)
	-- 8467
	local count67 = SkillApi:GetAttr(self, caster, target,2,"hp")
	-- 700511302
	self.order = self.order + 1
...
function Skill700511305:tFunc_700511301_700511303(caster, target, data)
	-- 700511303
	self.order = self.order + 1
