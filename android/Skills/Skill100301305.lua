...
---------------------------------------------
-- 技能基类
Skill100301305 = oo.class(SkillBase)
function Skill100301305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100301305:DoSkill(caster, target, data)
	-- 11051
...
-- 行动结束
function Skill100301305:OnActionOver(caster, target, data)
	-- 8060
