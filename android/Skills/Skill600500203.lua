...
---------------------------------------------
-- 技能基类
Skill600500203 = oo.class(SkillBase)
function Skill600500203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600500203:DoSkill(caster, target, data)
	-- 11004
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11004], caster, target, data, 0.25,4)
end
-- 攻击结束
function Skill600500203:OnAttackOver(caster, target, data)
	-- 8060
