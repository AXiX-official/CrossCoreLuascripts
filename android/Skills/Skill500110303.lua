...
---------------------------------------------
-- 技能基类
Skill500110303 = oo.class(SkillBase)
function Skill500110303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill500110303:DoSkill(caster, target, data)
	-- 12801
...
-- 攻击结束
function Skill500110303:OnAttackOver(caster, target, data)
	-- 8060
