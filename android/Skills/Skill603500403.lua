...
---------------------------------------------
-- 技能基类
Skill603500403 = oo.class(SkillBase)
function Skill603500403:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill603500403:DoSkill(caster, target, data)
	-- 12001
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12001], caster, target, data, 1,1)
end
-- 攻击结束
function Skill603500403:OnAttackOver(caster, target, data)
	-- 8060
