...
---------------------------------------------
-- 技能基类
Skill703100102 = oo.class(SkillBase)
function Skill703100102:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill703100102:DoSkill(caster, target, data)
	-- 12002
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12002], caster, target, data, 0.5,2)
end
-- 伤害后
function Skill703100102:OnAfterHurt(caster, target, data)
	-- 8060
