...
---------------------------------------------
-- 技能基类
Skill303100305 = oo.class(SkillBase)
function Skill303100305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill303100305:DoSkill(caster, target, data)
	-- 12705
...
-- 攻击结束
function Skill303100305:OnAttackOver(caster, target, data)
	-- 8060
