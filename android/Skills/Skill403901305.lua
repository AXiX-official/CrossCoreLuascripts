...
function Skill403901305:OnBefourCritHurt(caster, target, data)
	-- 8060
	...
	-- 403901305
	self:AddTempAttr(SkillEffect[403901305], caster, self.card, data, "crit",0.5)
	-- 8464
	local count64 = SkillApi:GetAttr(self, caster, target,3,"crit_rate")
	-- 403901310
	self:AddTempAttr(SkillEffect[403901310], caster, self.card, data, "damage",math.max((count64+0.5-1)*3,0))
end
