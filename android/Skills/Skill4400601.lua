...
---------------------------------------------
-- 技能基类
Skill4400601 = oo.class(SkillBase)
function Skill4400601:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束2
function Skill4400601:OnActionOver2(caster, target, data)
	-- 8060
...
-- 入场时
function Skill4400601:OnBorn(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 特殊入场时(复活，召唤，合体)
function Skill4400601:OnBornSpecial(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
