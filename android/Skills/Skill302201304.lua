...
---------------------------------------------
-- 技能基类
Skill302201304 = oo.class(SkillBase)
function Skill302201304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill302201304:DoSkill(caster, target, data)
	-- 11003
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11003], caster, target, data, 0.333,3)
end
-- 死亡时
function Skill302201304:OnDeath(caster, target, data)
	-- 8060
...
-- 伤害前
function Skill302201304:OnBefourHurt(caster, target, data)
	-- 302200301
	self:tFunc_302200301_302200302(caster, target, data)
	self:tFunc_302200301_302200303(caster, target, data)
end
-- 攻击开始
function Skill302201304:OnAttackBegin(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill302201304:tFunc_302200301_302200302(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill302201304:tFunc_302200301_302200303(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
