...
---------------------------------------------
-- 技能基类
Skill603100201 = oo.class(SkillBase)
function Skill603100201:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill603100201:DoSkill(caster, target, data)
	-- 12003
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12003], caster, target, data, 0.333,3)
end
-- 回合开始时
function Skill603100201:OnRoundBegin(caster, target, data)
	-- 8060
