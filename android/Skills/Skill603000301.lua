...
---------------------------------------------
-- 技能基类
Skill603000301 = oo.class(SkillBase)
function Skill603000301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill603000301:DoSkill(caster, target, data)
	-- 11006
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11006], caster, target, data, 0.167,6)
end
-- 攻击结束
function Skill603000301:OnAttackOver(caster, target, data)
	-- 8060
