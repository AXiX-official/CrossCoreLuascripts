...
---------------------------------------------
-- 技能基类
Skill50030301 = oo.class(SkillBase)
function Skill50030301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill50030301:DoSkill(caster, target, data)
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11002], caster, target, data, 0.5,2)
end
-- 攻击结束
function Skill50030301:OnAttackOver(caster, target, data)
