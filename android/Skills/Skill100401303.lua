...
---------------------------------------------
-- 技能基类
Skill100401303 = oo.class(SkillBase)
function Skill100401303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100401303:DoSkill(caster, target, data)
	-- 100400311
	self.order = self.order + 1
	self:AddLightShieldCount(SkillEffect[100400311], caster, target, data, 2309,4,10)
end
-- 伤害后
function Skill100401303:OnAfterHurt(caster, target, data)
	-- 8063
	...
	-- 100400304
	self:AddHp(SkillEffect[100400304], caster, caster, data, -count21*0.20)
end
