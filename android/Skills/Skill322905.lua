...
---------------------------------------------
-- 技能基类
Skill322905 = oo.class(SkillBase)
function Skill322905:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合开始时
function Skill322905:OnRoundBegin(caster, target, data)
	-- 4102301
...
-- 攻击开始
function Skill322905:OnAttackBegin(caster, target, data)
	-- 8063
	...
	-- 4102315
	self:AddBuff(SkillEffect[4102315], caster, caster, data, 4102315)
end
-- 入场时
function Skill322905:OnBorn(caster, target, data)
	-- 4102306
