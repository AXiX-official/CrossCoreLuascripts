...
---------------------------------------------
-- 技能基类
Skill942300303 = oo.class(SkillBase)
function Skill942300303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill942300303:DoSkill(caster, target, data)
	-- 704300303
	self.order = self.order + 1
	self:AddBuff(SkillEffect[704300303], caster, target, data, 704300303)
end
-- 伤害后
function Skill942300303:OnAfterHurt(caster, target, data)
	-- 8063
