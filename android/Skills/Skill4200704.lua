...
---------------------------------------------
-- 技能基类
Skill4200704 = oo.class(SkillBase)
function Skill4200704:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill4200704:OnDeath(caster, target, data)
	-- 8254
	...
	-- 4200704
	self:PassiveRevive(SkillEffect[4200704], caster, target, data, 2,0.8,{progress=600})
	-- 4200713
...
-- 行动开始
function Skill4200704:OnActionBegin(caster, target, data)
	-- 8063
...
-- 入场时
function Skill4200704:OnBorn(caster, target, data)
	-- 8060
