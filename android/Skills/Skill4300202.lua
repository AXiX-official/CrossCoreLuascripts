...
---------------------------------------------
-- 技能基类
Skill4300202 = oo.class(SkillBase)
function Skill4300202:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill4300202:OnAttackOver(caster, target, data)
	-- 8060
	...
	-- 4300202
	self:LimitDamage(SkillEffect[4300202], caster, target, data, 1,0.3)
	-- 4300207
