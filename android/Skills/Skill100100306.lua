...
---------------------------------------------
-- 技能基类
Skill100100306 = oo.class(SkillBase)
function Skill100100306:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100100306:DoSkill(caster, target, data)
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 行动结束
function Skill100100306:OnActionOver(caster, target, data)
