...
---------------------------------------------
-- 技能基类
Skill305000404 = oo.class(SkillBase)
function Skill305000404:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill305000404:DoSkill(caster, target, data)
	-- 11501
...
-- 行动结束2
function Skill305000404:OnActionOver2(caster, target, data)
	-- 8060
...
-- 攻击结束
function Skill305000404:OnAttackOver(caster, target, data)
	-- 8063
...
-- 行动结束
function Skill305000404:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 回合开始时
function Skill305000404:OnRoundBegin(caster, target, data)
	-- 305000320
