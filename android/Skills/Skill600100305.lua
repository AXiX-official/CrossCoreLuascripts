...
---------------------------------------------
-- 技能基类
Skill600100305 = oo.class(SkillBase)
function Skill600100305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600100305:DoSkill(caster, target, data)
	-- 12001
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12001], caster, target, data, 1,1)
end
-- 死亡时
function Skill600100305:OnDeath(caster, target, data)
	-- 8060
...
-- 伤害前
function Skill600100305:OnBefourHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
