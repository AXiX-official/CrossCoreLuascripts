...
---------------------------------------------
-- 技能基类
Skill4404003 = oo.class(SkillBase)
function Skill4404003:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill4404003:OnAttackOver(caster, target, data)
	-- 8060
...
function Skill4404003:tFunc_4404008_4404006(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4404003:tFunc_4404008_4404007(caster, target, data)
	-- 8063
