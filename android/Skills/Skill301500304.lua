...
---------------------------------------------
-- 技能基类
Skill301500304 = oo.class(SkillBase)
function Skill301500304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill301500304:DoSkill(caster, target, data)
	-- 12701
...
-- 攻击结束
function Skill301500304:OnAttackOver(caster, target, data)
	-- 8060
