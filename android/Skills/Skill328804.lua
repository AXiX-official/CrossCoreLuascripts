...
---------------------------------------------
-- 技能基类
Skill328804 = oo.class(SkillBase)
function Skill328804:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill328804:OnAttackOver(caster, target, data)
	-- 8063
	...
	-- 328804
	self:AddBuff(SkillEffect[328804], caster, caster, data, 328803)
end
