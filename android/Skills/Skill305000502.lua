...
---------------------------------------------
-- 技能基类
Skill305000502 = oo.class(SkillBase)
function Skill305000502:Init(skillID, card)
...
-- 行动结束2
function Skill305000502:OnActionOver2(caster, target, data)
	-- 8060
...
-- 伤害后
function Skill305000502:OnAfterHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	...
	-- 305000502
	self:LimitDamage(SkillEffect[305000502], caster, target, data, 0.05,5)
end
