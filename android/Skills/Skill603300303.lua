...
---------------------------------------------
-- 技能基类
Skill603300303 = oo.class(SkillBase)
function Skill603300303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill603300303:DoSkill(caster, target, data)
	-- 12004
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 死亡时
function Skill603300303:OnDeath(caster, target, data)
	-- 8070
...
-- 伤害前
function Skill603300303:OnBefourHurt(caster, target, data)
	-- 8060
...
function Skill603300303:tFunc_603300115_603300105(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill603300303:tFunc_603300115_603300112(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
