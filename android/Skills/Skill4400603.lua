...
---------------------------------------------
-- 技能基类
Skill4400603 = oo.class(SkillBase)
function Skill4400603:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束2
function Skill4400603:OnActionOver2(caster, target, data)
	-- 8060
	...
	for i,target in ipairs(targets) do
		self:OwnerAddBuff(SkillEffect[4400603], caster, target, data, 1044)
	end
	-- 4400607
	self:DelValue(SkillEffect[4400607], caster, self.card, data, "dmg4006")
end
-- 入场时
function Skill4400603:OnBorn(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4400603:OnBefourCritHurt(caster, target, data)
	-- 8062
