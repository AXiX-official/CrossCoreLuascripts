...
---------------------------------------------
-- 技能基类
Skill303101302 = oo.class(SkillBase)
function Skill303101302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill303101302:DoSkill(caster, target, data)
	-- 12705
...
-- 攻击结束
function Skill303101302:OnAttackOver(caster, target, data)
	-- 8060
