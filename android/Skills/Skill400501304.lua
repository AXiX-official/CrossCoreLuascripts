...
---------------------------------------------
-- 技能基类
Skill400501304 = oo.class(SkillBase)
function Skill400501304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill400501304:DoSkill(caster, target, data)
	-- 12401
...
-- 伤害后
function Skill400501304:OnAfterHurt(caster, target, data)
	-- 8060
