...
---------------------------------------------
-- 技能基类
Skill4200705 = oo.class(SkillBase)
function Skill4200705:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill4200705:OnDeath(caster, target, data)
	-- 8254
	...
	-- 4200705
	self:PassiveRevive(SkillEffect[4200705], caster, target, data, 2,1,{progress=600})
	-- 4200713
...
-- 行动开始
function Skill4200705:OnActionBegin(caster, target, data)
	-- 8063
...
-- 入场时
function Skill4200705:OnBorn(caster, target, data)
	-- 8060
