...
---------------------------------------------
-- 技能基类
Skill326903 = oo.class(SkillBase)
function Skill326903:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill326903:OnDeath(caster, target, data)
	-- 8070
...
-- 回合开始时
function Skill326903:OnRoundBegin(caster, target, data)
	-- 8060
