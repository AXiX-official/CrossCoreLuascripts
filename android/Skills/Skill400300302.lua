...
---------------------------------------------
-- 技能基类
Skill400300302 = oo.class(SkillBase)
function Skill400300302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill400300302:DoSkill(caster, target, data)
	-- 11001
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11001], caster, target, data, 1,1)
end
-- 攻击结束
function Skill400300302:OnAttackOver(caster, target, data)
	-- 8060
