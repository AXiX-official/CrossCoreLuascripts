...
-- 攻击结束2
function Skill4703301:OnAttackOver2(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 特殊入场时(复活，召唤，合体)
function Skill4703301:OnBornSpecial(caster, target, data)
	-- 8166
	...
	-- 4703311
	self:AddBuff(SkillEffect[4703311], caster, self.card, data, 4703301)
end
-- 攻击结束
function Skill4703301:OnAttackOver(caster, target, data)
	...
	-- 8911
	if SkillJudger:TargetPercentHp(self, caster, target, false,0.1) then
	else
		return
	end
	-- 8462
	...
	-- 703300311
	self:AddHp(SkillEffect[703300311], caster, target, data, -math.min(count67,count62*4),1)
end
