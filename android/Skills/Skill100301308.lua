...
---------------------------------------------
-- 技能基类
Skill100301308 = oo.class(SkillBase)
function Skill100301308:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100301308:DoSkill(caster, target, data)
...
-- 行动结束
function Skill100301308:OnActionOver(caster, target, data)
