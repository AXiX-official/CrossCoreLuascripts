...
---------------------------------------------
-- 技能基类
Skill322904 = oo.class(SkillBase)
function Skill322904:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合开始时
function Skill322904:OnRoundBegin(caster, target, data)
	-- 4102301
...
-- 攻击开始
function Skill322904:OnAttackBegin(caster, target, data)
	-- 8063
	...
	-- 4102314
	self:AddBuff(SkillEffect[4102314], caster, caster, data, 4102314)
end
-- 入场时
function Skill322904:OnBorn(caster, target, data)
	-- 4102306
