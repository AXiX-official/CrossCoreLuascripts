...
---------------------------------------------
-- 技能基类
Skill4703005 = oo.class(SkillBase)
function Skill4703005:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill4703005:OnAfterHurt(caster, target, data)
	-- 8063
...
-- 入场时
function Skill4703005:OnBorn(caster, target, data)
	-- 8060
	...
	-- 4702903
	self:AddBuff(SkillEffect[4702903], caster, self.card, data, 4702803)
end
-- 行动结束
function Skill4703005:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	...
	for i,target in ipairs(targets) do
		self:Cure(SkillEffect[4702915], caster, target, data, 4,0.50)
	end
end
