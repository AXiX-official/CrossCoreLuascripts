...
function Skill4302601:OnBorn(caster, target, data)
	-- 4302631
	self:tFunc_4302631_4302601(caster, target, data)
	self:tFunc_4302631_4302621(caster, target, data)
	self:tFunc_4302631_4302622(caster, target, data)
	self:tFunc_4302631_4302623(caster, target, data)
	self:tFunc_4302631_4302624(caster, target, data)
end
-- 回合开始时
function Skill4302601:OnRoundBegin(caster, target, data)
	-- 8728
...
-- 伤害前
function Skill4302601:OnBefourHurt(caster, target, data)
	-- 8062
	...
	-- 4302651
	self:AddTempAttr(SkillEffect[4302651], caster, target, data, "bedamage",count730*0.01)
end
function Skill4302601:tFunc_4302631_4302622(caster, target, data)
	-- 8274
...
function Skill4302601:tFunc_4302631_4302624(caster, target, data)
	-- 8271
...
function Skill4302601:tFunc_4302631_4302621(caster, target, data)
	-- 8060
...
function Skill4302601:tFunc_4302631_4302601(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4302601:tFunc_4302631_4302623(caster, target, data)
	-- 8273
