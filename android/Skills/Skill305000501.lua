...
-- 行动结束2
function Skill305000501:OnActionOver2(caster, target, data)
	-- 8060
...
-- 攻击结束
function Skill305000501:OnAttackOver(caster, target, data)
	-- 8063
...
-- 伤害后
function Skill305000501:OnAfterHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
