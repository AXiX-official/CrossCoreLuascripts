...
---------------------------------------------
-- 技能基类
Skill702900203 = oo.class(SkillBase)
function Skill702900203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill702900203:DoSkill(caster, target, data)
	-- 11091
...
-- 攻击结束
function Skill702900203:OnAttackOver(caster, target, data)
	-- 8063
