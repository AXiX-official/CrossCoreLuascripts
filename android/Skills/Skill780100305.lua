...
---------------------------------------------
-- 技能基类
Skill780100305 = oo.class(SkillBase)
function Skill780100305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill780100305:DoSkill(caster, target, data)
	-- 12004
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 死亡时
function Skill780100305:OnDeath(caster, target, data)
	-- 8070
...
-- 伤害前
function Skill780100305:OnBefourHurt(caster, target, data)
	-- 8060
...
function Skill780100305:tFunc_603300116_603300106(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill780100305:tFunc_603300116_603300113(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
