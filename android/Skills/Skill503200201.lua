...
---------------------------------------------
-- 技能基类
Skill503200201 = oo.class(SkillBase)
function Skill503200201:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill503200201:DoSkill(caster, target, data)
	-- 12811
...
-- 攻击结束
function Skill503200201:OnAttackOver(caster, target, data)
	-- 8060
