...
---------------------------------------------
-- 技能基类
Skill4304305 = oo.class(SkillBase)
function Skill4304305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4304305:OnBorn(caster, target, data)
	-- 8060
	...
	for i,target in ipairs(targets) do
		self:AddBuff(SkillEffect[4304305], caster, target, data, 4304305)
	end
	-- 4304306
