...
---------------------------------------------
-- 技能基类
Skill941800501 = oo.class(SkillBase)
function Skill941800501:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill941800501:OnActionOver(caster, target, data)
	-- 8062
...
-- 行动结束2
function Skill941800501:OnActionOver2(caster, target, data)
	-- 8062
	if SkillJudger:CasterIsTeammate(self, caster, target, true) then
	else
		return
