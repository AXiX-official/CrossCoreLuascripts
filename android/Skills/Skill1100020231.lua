-- 总队长在场上时，其他队员退场时复活回复10%血量，受到的伤害增加30%
-- 本文件由工具自动生成,请不要直接编辑本文件
---------------------------------------------
-- 技能基类
Skill1100020231 = oo.class(SkillBase)
function Skill1100020231:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill1100020231:OnBorn(caster, target, data)
	-- 9744
...
-- 死亡时
function Skill1100020231:OnDeath(caster, target, data)
	-- 11000202300
...
-- 特殊入场时(复活，召唤，合体)
function Skill1100020231:OnBornSpecial(caster, target, data)
	-- 11000202301
...
-- 伤害前
function Skill1100020231:OnBefourHurt(caster, target, data)
	-- 8063
	...
	-- 11000202319
	self:AddTempAttrPercent(SkillEffect[11000202319], caster, self.card, data, "bedamage",0.3)
end
function Skill1100020231:tFunc_11000202301_11000202317(caster, target, data)
	-- 8060
...
function Skill1100020231:tFunc_11000202300_11000202312(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
...
function Skill1100020231:tFunc_11000202300_1100020231(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
...
function Skill1100020231:tFunc_11000202301_11000202316(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill1100020231:tFunc_11000202300_11000202311(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
...
function Skill1100020231:tFunc_11000202301_11000202314(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill1100020231:tFunc_11000202301_11000202315(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill1100020231:tFunc_11000202300_11000202310(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
