...
---------------------------------------------
-- 技能基类
Skill4704101 = oo.class(SkillBase)
function Skill4704101:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4704101:OnBorn(caster, target, data)
	-- 8060
...
-- 回合开始时
function Skill4704101:OnRoundBegin(caster, target, data)
	-- 8062
	...
	if self:Rand(3000) then
		self:OwnerAddBuffCount(SkillEffect[4704111], caster, self.card, data, 704100101,1,6)
	end
end
-- 伤害后
function Skill4704101:OnAfterHurt(caster, target, data)
	-- 8063
