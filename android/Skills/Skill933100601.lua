...
---------------------------------------------
-- 技能基类
Skill933100601 = oo.class(SkillBase)
function Skill933100601:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill933100601:OnAttackOver(caster, target, data)
	-- 8063
...
-- 行动结束2
function Skill933100601:OnActionOver2(caster, target, data)
	-- 933101608
...
-- 行动结束
function Skill933100601:OnActionOver(caster, target, data)
	-- 932800605
...
-- 入场时
function Skill933100601:OnBorn(caster, target, data)
	-- 8060
