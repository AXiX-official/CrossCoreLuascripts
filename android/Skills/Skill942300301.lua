...
---------------------------------------------
-- 技能基类
Skill942300301 = oo.class(SkillBase)
function Skill942300301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill942300301:DoSkill(caster, target, data)
	-- 704300301
	self.order = self.order + 1
	self:AddBuff(SkillEffect[704300301], caster, target, data, 704300301)
end
-- 伤害后
function Skill942300301:OnAfterHurt(caster, target, data)
	-- 8063
