...
---------------------------------------------
-- 技能基类
Skill305001301 = oo.class(SkillBase)
function Skill305001301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill305001301:DoSkill(caster, target, data)
	-- 11501
...
-- 伤害前
function Skill305001301:OnBefourHurt(caster, target, data)
	-- 8060
