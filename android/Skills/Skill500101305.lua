...
---------------------------------------------
-- 技能基类
Skill500101305 = oo.class(SkillBase)
function Skill500101305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill500101305:DoSkill(caster, target, data)
	-- 11004
...
-- 行动结束
function Skill500101305:OnActionOver(caster, target, data)
	-- 8060
