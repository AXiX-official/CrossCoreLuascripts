...
---------------------------------------------
-- 技能基类
Skill702900205 = oo.class(SkillBase)
function Skill702900205:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill702900205:DoSkill(caster, target, data)
	-- 11091
...
-- 攻击结束
function Skill702900205:OnAttackOver(caster, target, data)
	-- 8063
