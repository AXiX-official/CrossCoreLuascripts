...
---------------------------------------------
-- 技能基类
Skill102101304 = oo.class(SkillBase)
function Skill102101304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill102101304:DoSkill(caster, target, data)
	-- 11121
...
-- 行动结束
function Skill102101304:OnActionOver(caster, target, data)
	-- 8060
