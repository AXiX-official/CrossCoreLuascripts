...
---------------------------------------------
-- 技能基类
Skill332604 = oo.class(SkillBase)
function Skill332604:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill332604:OnBefourHurt(caster, target, data)
	-- 8063
...
-- 伤害后
function Skill332604:OnAfterHurt(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	...
	-- 332604
	self:AddBuffCount(SkillEffect[332604], caster, self.card, data, 332604,1,5)
end
-- 行动结束2
function Skill332604:OnActionOver2(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
