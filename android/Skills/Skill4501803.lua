...
---------------------------------------------
-- 技能基类
Skill4501803 = oo.class(SkillBase)
function Skill4501803:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4501803:OnBorn(caster, target, data)
	-- 8381
...
function Skill4501803:tFunc_8381_8314(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4501803:tFunc_8383_8353(caster, target, data)
	-- 8070
...
function Skill4501803:tFunc_8382_8373(caster, target, data)
	-- 8070
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4501803:tFunc_8383_8352(caster, target, data)
	-- 8070
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4501803:tFunc_8381_8315(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4501803:tFunc_8382_8372(caster, target, data)
	-- 8070
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
