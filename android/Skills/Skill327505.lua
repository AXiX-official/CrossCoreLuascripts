...
---------------------------------------------
-- 技能基类
Skill327505 = oo.class(SkillBase)
function Skill327505:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 加buff时
function Skill327505:OnAddBuff(caster, target, data, buffer)
	-- 8063
	...
	if self:Rand(5000) then
		self:DelBufferGroup(SkillEffect[327505], caster, target, data, 1,1)
		-- 327511
