...
---------------------------------------------
-- 技能基类
Skill601500203 = oo.class(SkillBase)
function Skill601500203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill601500203:DoSkill(caster, target, data)
	-- 11003
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11003], caster, target, data, 0.333,3)
end
-- 攻击结束
function Skill601500203:OnAttackOver(caster, target, data)
	-- 8060
