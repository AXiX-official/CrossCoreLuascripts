...
---------------------------------------------
-- 技能基类
Skill4603211 = oo.class(SkillBase)
function Skill4603211:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill4603211:OnRoundOver(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill4603211:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
