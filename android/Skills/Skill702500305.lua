...
---------------------------------------------
-- 技能基类
Skill702500305 = oo.class(SkillBase)
function Skill702500305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill702500305:DoSkill(caster, target, data)
	-- 12004
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 加buff时
function Skill702500305:OnAddBuff(caster, target, data, buffer)
	-- 8060
...
-- 伤害前
function Skill702500305:OnBefourHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
