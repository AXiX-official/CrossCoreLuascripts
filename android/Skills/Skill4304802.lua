...
---------------------------------------------
-- 技能基类
Skill4304802 = oo.class(SkillBase)
function Skill4304802:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4304802:OnBorn(caster, target, data)
	-- 8060
...
-- 攻击结束
function Skill4304802:OnAttackOver(caster, target, data)
	-- 8063
...
-- 行动结束2
function Skill4304802:OnActionOver2(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
...
-- 行动结束
function Skill4304802:OnActionOver(caster, target, data)
	-- 8684
