...
---------------------------------------------
-- 技能基类
Skill322203 = oo.class(SkillBase)
function Skill322203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill322203:OnDeath(caster, target, data)
	-- 8060
	...
	-- 322203
	self:OwnerAddBuffCount(SkillEffect[322203], caster, self.card, data, 322203,1,5)
end
