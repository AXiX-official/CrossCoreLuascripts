...
---------------------------------------------
-- 技能基类
Skill4601403 = oo.class(SkillBase)
function Skill4601403:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill4601403:OnBefourHurt(caster, target, data)
	-- 8166
	...
	-- 4601403
	self:LimitDamage(SkillEffect[4601403], caster, target, data, 0.06,0.72)
	-- 4601406
