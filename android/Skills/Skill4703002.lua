...
---------------------------------------------
-- 技能基类
Skill4703002 = oo.class(SkillBase)
function Skill4703002:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill4703002:OnAfterHurt(caster, target, data)
	-- 8063
...
-- 入场时
function Skill4703002:OnBorn(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill4703002:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
