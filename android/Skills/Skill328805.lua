...
---------------------------------------------
-- 技能基类
Skill328805 = oo.class(SkillBase)
function Skill328805:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill328805:OnAttackOver(caster, target, data)
	-- 8063
	...
	-- 328805
	self:AddBuff(SkillEffect[328805], caster, caster, data, 328804)
end
