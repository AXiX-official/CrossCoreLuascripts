...
---------------------------------------------
-- 技能基类
Skill300201302 = oo.class(SkillBase)
function Skill300201302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill300201302:DoSkill(caster, target, data)
	-- 11051
...
-- 伤害前
function Skill300201302:OnBefourHurt(caster, target, data)
	-- 8060
