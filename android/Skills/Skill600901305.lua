...
---------------------------------------------
-- 技能基类
Skill600901305 = oo.class(SkillBase)
function Skill600901305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600901305:DoSkill(caster, target, data)
	-- 600901305
	self.order = self.order + 1
	self:AddProgress(SkillEffect[600901305], caster, target, data, 300)
end
-- 行动结束
function Skill600901305:OnActionOver(caster, target, data)
	-- 8060
...
-- 回合结束时
function Skill600901305:OnRoundOver(caster, target, data)
	-- 8062
