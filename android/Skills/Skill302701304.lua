...
---------------------------------------------
-- 技能基类
Skill302701304 = oo.class(SkillBase)
function Skill302701304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill302701304:DoSkill(caster, target, data)
	-- 12004
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 攻击结束
function Skill302701304:OnAttackOver(caster, target, data)
	-- 8060
...
-- 伤害前
function Skill302701304:OnBefourHurt(caster, target, data)
	-- 8073
	if SkillJudger:TargetIsEnemy(self, caster, target, true) then
	else
		return
