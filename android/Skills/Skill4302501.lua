...
-- 回合结束时
function Skill4302501:OnRoundOver(caster, target, data)
	-- 8733
	...
	-- 4302521
	self:DelBufferForce(SkillEffect[4302521], caster, caster, data, 4302501)
end
-- 回合开始时
function Skill4302501:OnRoundBegin(caster, target, data)
	-- 4302531
