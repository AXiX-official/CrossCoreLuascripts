...
function Skill1100010192:tFunc_1100010192_11000101923(caster, target, data)
	...
	-- 11000101923
	self:AddTempAttrPercent(SkillEffect[11000101923], caster, self.card, data, "attack",0.15)
end
function Skill1100010192:tFunc_1100010192_11000101922(caster, target, data)
	...
	-- 11000101922
	self:AddTempAttr(SkillEffect[11000101922], caster, self.card, data, "damage",0.1)
end
...
function Skill1100010192:tFunc_1100010192_11000101924(caster, target, data)
	...
	-- 11000101924
	self:AddTempAttrPercent(SkillEffect[11000101924], caster, self.card, data, "attack",0.2)
end
