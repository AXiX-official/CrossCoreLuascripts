...
---------------------------------------------
-- 技能基类
Skill700301304 = oo.class(SkillBase)
function Skill700301304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill700301304:DoSkill(caster, target, data)
	-- 12004
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 行动结束
function Skill700301304:OnActionOver(caster, target, data)
	-- 8200
