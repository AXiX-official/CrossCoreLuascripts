...
---------------------------------------------
-- 技能基类
Skill304001303 = oo.class(SkillBase)
function Skill304001303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill304001303:DoSkill(caster, target, data)
	-- 11004
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11004], caster, target, data, 0.25,4)
end
-- 伤害后
function Skill304001303:OnAfterHurt(caster, target, data)
	-- 8060
...
-- 伤害前
function Skill304001303:OnBefourHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
