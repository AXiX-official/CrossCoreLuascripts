...
---------------------------------------------
-- 技能基类
Skill4304804 = oo.class(SkillBase)
function Skill4304804:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4304804:OnBorn(caster, target, data)
	-- 8060
...
-- 攻击结束
function Skill4304804:OnAttackOver(caster, target, data)
	-- 8063
...
-- 行动结束
function Skill4304804:OnActionOver(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
...
-- 行动结束2
function Skill4304804:OnActionOver2(caster, target, data)
	-- 8684
	local count684 = SkillApi:GetCount(self, caster, target,3,304800101)
	-- 8897
	if SkillJudger:Greater(self, caster, target, true,count684,4) then
