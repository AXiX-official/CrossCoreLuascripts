...
---------------------------------------------
-- 技能基类
Skill922800602 = oo.class(SkillBase)
function Skill922800602:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill922800602:DoSkill(caster, target, data)
	-- 12001
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12001], caster, target, data, 1,1)
end
-- 入场时
function Skill922800602:OnBorn(caster, target, data)
	-- 8060
