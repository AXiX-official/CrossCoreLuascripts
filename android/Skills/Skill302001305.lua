...
---------------------------------------------
-- 技能基类
Skill302001305 = oo.class(SkillBase)
function Skill302001305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill302001305:DoSkill(caster, target, data)
	-- 11004
...
-- 伤害前
function Skill302001305:OnBefourHurt(caster, target, data)
	-- 8060
