...
---------------------------------------------
-- 技能基类
Skill4202302 = oo.class(SkillBase)
function Skill4202302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill4202302:OnActionOver(caster, target, data)
	-- 8060
...
-- 攻击结束2
function Skill4202302:OnAttackOver2(caster, target, data)
	-- 8071
	...
	-- 4202312
	self:CallOwnerSkill(SkillEffect[4202312], caster, target, data, 202300402)
	-- 4202302
	self:DelBufferForce(SkillEffect[4202302], caster, self.card, data, 4202301,1)
end
-- 入场时
function Skill4202302:OnBorn(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
