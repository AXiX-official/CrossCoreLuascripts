...
---------------------------------------------
-- 技能基类
Skill602101302 = oo.class(SkillBase)
function Skill602101302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill602101302:DoSkill(caster, target, data)
	-- 11401
...
-- 伤害前
function Skill602101302:OnBefourHurt(caster, target, data)
	-- 8060
...
-- 攻击结束
function Skill602101302:OnAttackOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
