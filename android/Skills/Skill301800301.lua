...
---------------------------------------------
-- 技能基类
Skill301800301 = oo.class(SkillBase)
function Skill301800301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill301800301:DoSkill(caster, target, data)
	-- 11081
...
-- 伤害前
function Skill301800301:OnBefourHurt(caster, target, data)
	-- 8060
