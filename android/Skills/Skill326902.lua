...
---------------------------------------------
-- 技能基类
Skill326902 = oo.class(SkillBase)
function Skill326902:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill326902:OnDeath(caster, target, data)
	-- 8070
...
-- 回合开始时
function Skill326902:OnRoundBegin(caster, target, data)
	-- 8060
