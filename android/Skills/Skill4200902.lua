...
---------------------------------------------
-- 技能基类
Skill4200902 = oo.class(SkillBase)
function Skill4200902:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill4200902:OnBefourHurt(caster, target, data)
	-- 8071
	...
	-- 4200902
	self:AddTempAttr(SkillEffect[4200902], caster, caster, data, "damage",-0.07)
	-- 4200906
