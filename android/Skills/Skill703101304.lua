...
---------------------------------------------
-- 技能基类
Skill703101304 = oo.class(SkillBase)
function Skill703101304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill703101304:DoSkill(caster, target, data)
	-- 12007
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12007], caster, target, data, 0.143,7)
end
-- 伤害后
function Skill703101304:OnAfterHurt(caster, target, data)
	-- 703100412
	self:tFunc_703100412_703100302(caster, target, data)
	self:tFunc_703100412_703100312(caster, target, data)
end
-- 行动结束2
function Skill703101304:OnActionOver2(caster, target, data)
	-- 8723
...
-- 回合开始时
function Skill703101304:OnRoundBegin(caster, target, data)
	-- 8723
	local count723 = SkillApi:GetCount(self, caster, target,3,4703101)
	-- 8937
	if SkillJudger:GreaterEqual(self, caster, self.card, true,count723,7) then
...
function Skill703101304:tFunc_703100412_703100302(caster, target, data)
	-- 8060
...
function Skill703101304:tFunc_703100412_703100312(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
