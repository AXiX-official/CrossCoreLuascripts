...
---------------------------------------------
-- 技能基类
Skill303101304 = oo.class(SkillBase)
function Skill303101304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill303101304:DoSkill(caster, target, data)
	-- 12705
...
-- 攻击结束
function Skill303101304:OnAttackOver(caster, target, data)
	-- 8060
