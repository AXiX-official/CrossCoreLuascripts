...
---------------------------------------------
-- 技能基类
Skill100200105 = oo.class(SkillBase)
function Skill100200105:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100200105:DoSkill(caster, target, data)
	-- 11002
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11002], caster, target, data, 0.5,2)
end
-- 攻击结束
function Skill100200105:OnAttackOver(caster, target, data)
	-- 8060
