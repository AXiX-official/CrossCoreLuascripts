...
---------------------------------------------
-- 技能基类
Skill703100301 = oo.class(SkillBase)
function Skill703100301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill703100301:DoSkill(caster, target, data)
	-- 12007
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12007], caster, target, data, 0.143,7)
end
-- 伤害后
function Skill703100301:OnAfterHurt(caster, target, data)
	-- 703100411
	self:tFunc_703100411_703100301(caster, target, data)
	self:tFunc_703100411_703100311(caster, target, data)
end
function Skill703100301:tFunc_703100411_703100301(caster, target, data)
	-- 8060
...
function Skill703100301:tFunc_703100411_703100311(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
