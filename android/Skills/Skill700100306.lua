...
---------------------------------------------
-- 技能基类
Skill700100306 = oo.class(SkillBase)
function Skill700100306:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill700100306:DoSkill(caster, target, data)
	self.order = self.order + 1
	self:DamageSpecial(SkillEffect[13003], caster, target, data, 0.333,3)
end
-- 行动结束
function Skill700100306:OnActionOver(caster, target, data)
