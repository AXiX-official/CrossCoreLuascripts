...
---------------------------------------------
-- 技能基类
Skill200700307 = oo.class(SkillBase)
function Skill200700307:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill200700307:DoSkill(caster, target, data)
...
-- 伤害后
function Skill200700307:OnAfterHurt(caster, target, data)
...
-- 治疗时
function Skill200700307:OnCure(caster, target, data)
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	end
