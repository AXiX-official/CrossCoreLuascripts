...
---------------------------------------------
-- 技能基类
Skill4942103 = oo.class(SkillBase)
function Skill4942103:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4942103:OnBorn(caster, target, data)
	-- 8060
...
-- 回合开始时
function Skill4942103:OnRoundBegin(caster, target, data)
	-- 8062
...
-- 伤害后
function Skill4942103:OnAfterHurt(caster, target, data)
	-- 8063
