...
---------------------------------------------
-- 技能基类
Skill304810401 = oo.class(SkillBase)
function Skill304810401:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill304810401:DoSkill(caster, target, data)
	-- 11006
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11006], caster, target, data, 0.167,6)
end
-- 暴击伤害前(OnBefourHurt之前)
function Skill304810401:OnBefourCritHurt(caster, target, data)
	-- 8060
