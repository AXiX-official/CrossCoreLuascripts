...
---------------------------------------------
-- 技能基类
Skill322204 = oo.class(SkillBase)
function Skill322204:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill322204:OnDeath(caster, target, data)
	-- 8060
	...
	-- 322204
	self:OwnerAddBuffCount(SkillEffect[322204], caster, self.card, data, 322204,1,5)
end
