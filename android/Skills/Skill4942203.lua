...
---------------------------------------------
-- 技能基类
Skill4942203 = oo.class(SkillBase)
function Skill4942203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4942203:OnBorn(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill4942203:OnActionOver(caster, target, data)
	-- 4704223
	self:tFunc_4704223_4704203(caster, target, data)
	self:tFunc_4704223_4704213(caster, target, data)
end
-- 伤害前
function Skill4942203:OnBefourHurt(caster, target, data)
	-- 4704233
	self:AddTempAttr(SkillEffect[4704233], caster, self.card, data, "damage",0.20)
end
function Skill4942203:tFunc_4704223_4704213(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4942203:tFunc_4704223_4704203(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
