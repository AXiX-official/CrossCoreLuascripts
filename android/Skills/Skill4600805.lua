...
---------------------------------------------
-- 技能基类
Skill4600805 = oo.class(SkillBase)
function Skill4600805:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4600805:OnBorn(caster, target, data)
	-- 4600806
	self:AddBuff(SkillEffect[4600806], caster, self.card, data, 6111)
end
-- 行动结束2
function Skill4600805:OnActionOver2(caster, target, data)
	-- 8063
...
-- 回合开始处理完成后
function Skill4600805:OnAfterRoundBegin(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
