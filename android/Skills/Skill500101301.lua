...
---------------------------------------------
-- 技能基类
Skill500101301 = oo.class(SkillBase)
function Skill500101301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill500101301:DoSkill(caster, target, data)
	-- 11004
...
-- 行动结束
function Skill500101301:OnActionOver(caster, target, data)
	-- 8060
