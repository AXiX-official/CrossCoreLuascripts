...
---------------------------------------------
-- 技能基类
Skill100301307 = oo.class(SkillBase)
function Skill100301307:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100301307:DoSkill(caster, target, data)
...
-- 行动结束
function Skill100301307:OnActionOver(caster, target, data)
