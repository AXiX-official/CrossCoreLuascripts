...
---------------------------------------------
-- 技能基类
Skill780100401 = oo.class(SkillBase)
function Skill780100401:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
function Skill780100401:CanSummon()
	return self.card:CanSummon(10000034,1,{4,1},{progress=1010})
end
-- 执行技能
function Skill780100401:DoSkill(caster, target, data)
	-- 40026
