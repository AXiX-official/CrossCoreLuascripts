...
---------------------------------------------
-- 技能基类
Skill601600301 = oo.class(SkillBase)
function Skill601600301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill601600301:DoSkill(caster, target, data)
	-- 12005
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12005], caster, target, data, 0.2,5)
end
-- 行动结束
function Skill601600301:OnActionOver(caster, target, data)
	-- 8060
...
-- 攻击结束
function Skill601600301:OnAttackOver(caster, target, data)
	-- 8062
...
-- 攻击结束2
function Skill601600301:OnAttackOver2(caster, target, data)
	-- 8062
	if SkillJudger:CasterIsTeammate(self, caster, target, true) then
	else
		return
	...
	-- 601600311
	self:LimitDamage(SkillEffect[601600311], caster, target, data, 1,4)
	-- 601600316
