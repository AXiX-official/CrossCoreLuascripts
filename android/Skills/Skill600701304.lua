...
---------------------------------------------
-- 技能基类
Skill600701304 = oo.class(SkillBase)
function Skill600701304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600701304:DoSkill(caster, target, data)
	-- 12601
...
-- 攻击开始
function Skill600701304:OnAttackBegin(caster, target, data)
	-- 8060
