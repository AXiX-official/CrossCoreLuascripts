...
-- 行动结束2
function Skill4300403:OnActionOver2(caster, target, data)
	-- 8679
	...
	-- 4300403
	self:AddProgress(SkillEffect[4300403], caster, self.card, data, 400)
	-- 4300416
	...
	-- 4300413
	self:AddBuff(SkillEffect[4300413], caster, self.card, data, 4003,1)
	-- 4300417
