...
---------------------------------------------
-- 技能基类
Skill309604 = oo.class(SkillBase)
function Skill309604:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill309604:OnAfterHurt(caster, target, data)
	-- 8060
	...
	-- 309604
	self:LimitDamage(SkillEffect[309604], caster, target, data, 0.12,1.2)
	-- 92018
