...
---------------------------------------------
-- 技能基类
Skill322903 = oo.class(SkillBase)
function Skill322903:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合开始时
function Skill322903:OnRoundBegin(caster, target, data)
	-- 4102301
...
-- 攻击开始
function Skill322903:OnAttackBegin(caster, target, data)
	-- 8063
	...
	-- 4102313
	self:AddBuff(SkillEffect[4102313], caster, caster, data, 4102313)
end
-- 入场时
function Skill322903:OnBorn(caster, target, data)
	-- 4102306
