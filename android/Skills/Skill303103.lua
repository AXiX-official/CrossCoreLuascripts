...
---------------------------------------------
-- 技能基类
Skill303103 = oo.class(SkillBase)
function Skill303103:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill303103:OnAttackOver(caster, target, data)
	-- 8060
	...
	elseif 2 == r then
		...
		-- 302803
		self:RelevanceBuff(SkillEffect[302803], caster, target, data, 8502,8512,3,4000)
		-- 8320
	...
	elseif 3 == r then
		...
		-- 302903
		self:RelevanceBuff(SkillEffect[302903], caster, target, data, 8503,8513,3,4000)
		-- 8322
