...
---------------------------------------------
-- 技能基类
Skill23102 = oo.class(SkillBase)
function Skill23102:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill23102:OnDeath(caster, target, data)
	-- 8060
	...
	for i,target in ipairs(targets) do
		self:AddHp(SkillEffect[23102], caster, target, data, -count47/math.max(1,count2)*1)
	end
	-- 231010
