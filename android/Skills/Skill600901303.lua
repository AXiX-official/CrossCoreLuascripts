...
---------------------------------------------
-- 技能基类
Skill600901303 = oo.class(SkillBase)
function Skill600901303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600901303:DoSkill(caster, target, data)
	-- 600901303
	self.order = self.order + 1
	self:AddProgress(SkillEffect[600901303], caster, target, data, 200)
end
-- 行动结束
function Skill600901303:OnActionOver(caster, target, data)
	-- 8060
...
-- 回合结束时
function Skill600901303:OnRoundOver(caster, target, data)
	-- 8062
