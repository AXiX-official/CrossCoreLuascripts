...
---------------------------------------------
-- 技能基类
Skill600901302 = oo.class(SkillBase)
function Skill600901302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600901302:DoSkill(caster, target, data)
	-- 600901302
	self.order = self.order + 1
	self:AddProgress(SkillEffect[600901302], caster, target, data, 150)
end
-- 行动结束
function Skill600901302:OnActionOver(caster, target, data)
	-- 8060
...
-- 回合结束时
function Skill600901302:OnRoundOver(caster, target, data)
	-- 8062
