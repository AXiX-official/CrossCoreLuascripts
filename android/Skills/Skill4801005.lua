...
---------------------------------------------
-- 技能基类
Skill4801005 = oo.class(SkillBase)
function Skill4801005:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill4801005:OnBefourHurt(caster, target, data)
	-- 8060
...
-- 特殊入场时(复活，召唤，合体)
function Skill4801005:OnBornSpecial(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
