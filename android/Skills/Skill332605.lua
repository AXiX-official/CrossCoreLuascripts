...
---------------------------------------------
-- 技能基类
Skill332605 = oo.class(SkillBase)
function Skill332605:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill332605:OnBefourHurt(caster, target, data)
	-- 8063
...
-- 伤害后
function Skill332605:OnAfterHurt(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	...
	-- 332605
	self:AddBuffCount(SkillEffect[332605], caster, self.card, data, 332605,1,5)
end
-- 行动结束2
function Skill332605:OnActionOver2(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
