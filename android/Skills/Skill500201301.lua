...
---------------------------------------------
-- 技能基类
Skill500201301 = oo.class(SkillBase)
function Skill500201301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill500201301:DoSkill(caster, target, data)
	-- 11003
...
-- 伤害前
function Skill500201301:OnBefourHurt(caster, target, data)
	-- 8060
