...
---------------------------------------------
-- 技能基类
Skill4600304 = oo.class(SkillBase)
function Skill4600304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 驱散buff时
function Skill4600304:OnDelBuff(caster, target, data)
	-- 8060
...
-- 伤害前
function Skill4600304:OnBefourHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 回合开始时
function Skill4600304:OnRoundBegin(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
