...
-- 行动结束2
function Skill305000503:OnActionOver2(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill305000503:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 伤害后
function Skill305000503:OnAfterHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	...
	-- 305000503
	self:LimitDamage(SkillEffect[305000503], caster, target, data, 0.05,6)
end
