...
---------------------------------------------
-- 技能基类
Skill4913901 = oo.class(SkillBase)
function Skill4913901:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill4913901:OnActionOver(caster, target, data)
	-- 8477
	...
	self:tFunc_4803604_4803606(caster, target, data)
end
-- 特殊入场时(复活，召唤，合体)
function Skill4913901:OnBornSpecial(caster, target, data)
	-- 8060
...
function Skill4913901:tFunc_4803604_4803602(caster, target, data)
	-- 8065
...
function Skill4913901:tFunc_4803604_4803606(caster, target, data)
	-- 8065
	if SkillJudger:CasterIsSummoner(self, caster, target, true) then
	else
		return
...
function Skill4913901:tFunc_4803604_4803601(caster, target, data)
	-- 8065
	if SkillJudger:CasterIsSummoner(self, caster, target, true) then
	else
		return
