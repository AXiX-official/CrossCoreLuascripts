...
---------------------------------------------
-- 技能基类
Skill703100303 = oo.class(SkillBase)
function Skill703100303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill703100303:DoSkill(caster, target, data)
	-- 12007
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12007], caster, target, data, 0.143,7)
end
-- 伤害后
function Skill703100303:OnAfterHurt(caster, target, data)
	-- 703100412
	self:tFunc_703100412_703100302(caster, target, data)
	self:tFunc_703100412_703100312(caster, target, data)
end
function Skill703100303:tFunc_703100412_703100302(caster, target, data)
	-- 8060
...
function Skill703100303:tFunc_703100412_703100312(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
