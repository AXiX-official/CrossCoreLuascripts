...
---------------------------------------------
-- 技能基类
Skill323505 = oo.class(SkillBase)
function Skill323505:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill323505:OnBefourHurt(caster, target, data)
	-- 8060
	...
	-- 323505
	self:AddTempAttr(SkillEffect[323505], caster, self.card, data, "damage",2)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
