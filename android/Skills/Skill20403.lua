...
---------------------------------------------
-- 技能基类
Skill20403 = oo.class(SkillBase)
function Skill20403:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动开始
function Skill20403:OnActionBegin(caster, target, data)
	-- 8060
	...
	-- 20403
	self:AddBuff(SkillEffect[20403], caster, self.card, data, 22603)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
