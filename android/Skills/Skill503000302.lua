...
---------------------------------------------
-- 技能基类
Skill503000302 = oo.class(SkillBase)
function Skill503000302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill503000302:DoSkill(caster, target, data)
	-- 11005
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11005], caster, target, data, 0.2,5)
end
-- 暴击伤害前(OnBefourHurt之前)
function Skill503000302:OnBefourCritHurt(caster, target, data)
	-- 8060
