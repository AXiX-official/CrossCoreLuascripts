...
---------------------------------------------
-- 技能基类
Skill4404005 = oo.class(SkillBase)
function Skill4404005:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill4404005:OnAttackOver(caster, target, data)
	-- 8060
	...
	-- 4404005
	self:HitAddBuff(SkillEffect[4404005], caster, target, data, 6000,4404001,2)
end
-- 伤害前
function Skill4404005:OnBefourHurt(caster, target, data)
	-- 4404008
	self:tFunc_4404008_4404006(caster, target, data)
	self:tFunc_4404008_4404007(caster, target, data)
end
function Skill4404005:tFunc_4404008_4404006(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4404005:tFunc_4404008_4404007(caster, target, data)
	-- 8063
