...
---------------------------------------------
-- 技能基类
Skill700301307 = oo.class(SkillBase)
function Skill700301307:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill700301307:DoSkill(caster, target, data)
	self.order = self.order + 1
	self:DamageSpecial(SkillEffect[13004], caster, target, data, 0.25,4)
end
-- 行动结束
function Skill700301307:OnActionOver(caster, target, data)
