...
---------------------------------------------
-- 技能基类
Skill302301301 = oo.class(SkillBase)
function Skill302301301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill302301301:DoSkill(caster, target, data)
	-- 12002
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12002], caster, target, data, 0.5,2)
end
-- 行动结束2
function Skill302301301:OnActionOver2(caster, target, data)
	-- 8060
...
-- 伤害前
function Skill302301301:OnBefourHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
