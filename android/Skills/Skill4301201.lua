...
---------------------------------------------
-- 技能基类
Skill4301201 = oo.class(SkillBase)
function Skill4301201:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill4301201:OnActionOver(caster, target, data)
	-- 8063
	...
	-- 4301201
	self:OwnerAddBuffCount(SkillEffect[4301201], caster, self.card, data, 4301201,1,5)
	-- 4301206
