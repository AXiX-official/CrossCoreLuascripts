...
cast2={play_time=13700,start_pos={ref_type=1},last_hit=12047,showDatas={{delay=0,isEnemy=1},{delay=5000,showState=1,isEnemy=1}}},
cast0={play_time=2150,start_pos={ref_type=1,offset_row=-100},last_hit=1648},
win={play_time=2000}
};
