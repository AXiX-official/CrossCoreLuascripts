...
{effect="cast1_eff",time=2200,type=0,pos_ref={ref_type=6}}
},
[806661594]={
...
{delay=1105,time=2000,type=1,hit_type=1,camera_shake={time=200,shake_dir=1,range=200,range1=100,hz=30,decay_value=0.25},hit_creates={661633433},hits={0}},
