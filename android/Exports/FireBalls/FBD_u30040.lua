...
{effect="cast1_hit",time=6000,type=0,pos_ref={ref_type=0,offset_row=250,lock_row=1}},
{effect="cast1_eff",time=6000,type=0,pos_ref={ref_type=6},path_target={ref_type=5,offset_row=350,lock_row=1}}
},
[1310282141]={
