...
{effect="cast2_eff",time=4000,type=0,pos_ref={ref_type=6,offset_row=-339,lock_col=1}},
...
{effect="cast1_hit",delay=1270,time=4000,type=0,pos_ref={ref_type=1,lock_col=1}}
},
[-1609092943]={
