...
{effect="cast1_eff",effect_no_flip=1,time=3500,path_index=300,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/seventeen.acb",cue_name="Longxian_attack_skill_01",path_target={ref_type=3,lock_col=1}}
},
[1310282141]={
{delay=5367,time=14000,type=0,cue_sheet="cv/Longxian.acb",cue_name="Longxian_12",cue_feature=1},
{effect="cast2_eff",time=13800,type=0,pos_ref={ref_type=10},cue_sheet="fight/effect/seventeen.acb",cue_name="Longxian_attack_skill_02"},
