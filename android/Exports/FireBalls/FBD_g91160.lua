...
{
[-1183793042]={
{effect="enter_eff",effect_pack="g90770",delay=500,time=2000,type=0,pos_ref={ref_type=6}}
},
[1310282141]={
{time=4000,type=0,cue_sheet="fight/effect/seventh.acb",cue_name="Frost_guard_attack_skill_02"},
{effect="cast2_eff",time=3300,type=0,pos_ref={ref_type=6,offset_row=-339,lock_col=1}},
{delay=1800,time=5000,type=1,hit_type=1,hits={0,300}}
},
[-686817241]={
...
{delay=1450,time=2000,type=1,hit_type=1,camera_shake={time=500,shake_dir=1,range=500,range1=300,range2=25,hz=30,decay_value=0.3},hits={0}},
{time=4000,type=0,cue_sheet="fight/effect/seventh.acb",cue_name="Frost_guard_attack_skill_01"},
{effect="cast1_hit",time=3000,type=0,pos_ref={ref_type=0,offset_row=115,lock_col=1}}
},
[-1609092943]={
{effect="cast0_eff",time=3000,type=0,pos_ref={ref_type=6},path_target={ref_type=1}},
{delay=620,time=2000,type=1,hit_type=1,camera_shake={time=500,shake_dir=1,range=120,range1=300,range2=25,hz=30,decay_value=0.3},hit_creates={661633433},hits={0}},
