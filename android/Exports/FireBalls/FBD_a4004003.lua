...
{
[1310282141]={
{effect="Cast2_hit2",effect_pack="a40040",delay=3833,time=500,type=0,pos_ref={ref_type=10}},
{effect="Cast2_hit3",effect_pack="a40040",delay=3933,time=500,type=0,pos_ref={ref_type=10}},
{time=6000,type=1,hit_type=1,camera_shake={time=150,shake_dir=1,range=200,hz=200,decay_value=0.25},hits={4000,4300,5200,5500}},
{effect="Cast2_eff",effect_pack="a40040",time=6000,type=0,pos_ref={ref_type=6}},
{time=6000,type=0,cue_sheet="fight/effect/sixth.acb",cue_name="Prominence_attack_skill_02"},
{effect="Cast2_hit1",effect_pack="a40040",delay=3800,time=500,type=0,pos_ref={ref_type=10}},
{delay=733,time=6000,type=0,cue_sheet="cv/prominence.acb",cue_name="prominence_11",cue_feature=1},
{effect="Cast2_hit5",effect_pack="a40040",delay=4400,time=1000,type=0,pos_ref={ref_type=10}},
{effect="Cast2_hit4",effect_pack="a40040",delay=4000,time=500,type=0,pos_ref={ref_type=10}}
},
[-686817241]={
{effect="Cast1_eff",effect_pack="a40040",time=2000,type=0,pos_ref={ref_type=6},cue_sheet="cv/prominence.acb",cue_name="prominence_10",cue_feature=1},
...
{effect="Cast1_hit",effect_pack="a40040",time=4000,type=0,pos_ref={ref_type=1,lock_col=1}},
...
{effect="Cast0_eff",effect_pack="a40040",time=2000,type=0,pos_ref={ref_type=6},cue_sheet="cv/prominence.acb",cue_name="prominence_09",cue_feature=1,path_target={ref_type=1}},
...
[-838067028]={
effect="Cast0_hit2",effect_pack="a40040",time=2000,type=0,pos_ref={ref_type=4,part_index=0}
},
[661633433]={
effect="Cast0_hit1",effect_pack="a40040",time=2000,type=0,pos_ref={ref_type=4,part_index=0}
}
};
