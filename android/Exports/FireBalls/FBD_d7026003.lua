...
{effect="cast2_eff",effect_pack="d70260",time=10700,type=0,pos_ref={ref_type=10}},
...
{effect="cast1_eff",effect_pack="d70260",time=2060,type=0,pos_ref={ref_type=6},cue_sheet="cv/Thor.acb",cue_name="Thor_10",cue_feature=1},
...
{effect="cast0_hit",effect_pack="d70260",time=3820,type=0,pos_ref={ref_type=1}},
{time=3500,type=0,cue_sheet="fight/effect/twelfth.acb",cue_name="Thor_attack_general"},
{effect="cast0_eff",effect_pack="d70260",time=2700,path_index=0,type=0,pos_ref={ref_type=6},cue_sheet="cv/Thor.acb",cue_name="Thor_09",cue_feature=1,path_target={ref_type=1}},
...
[-1328923786]={
{effect="win_eff",effect_pack="d70260",time=2200,type=0,pos_ref={ref_type=6}}
},
[-1183793042]={
{effect="enter_eff",effect_pack="d70260",time=2740,type=0,pos_ref={ref_type=6}}
}
};
