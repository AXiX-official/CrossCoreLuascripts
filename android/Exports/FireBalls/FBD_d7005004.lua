...
{effect="cast2_eff",effect_pack="d7005003",time=6000,type=0,pos_ref={ref_type=6},cue_sheet="cv/Hades.acb",cue_name="Hades_10",cue_feature=1},
...
[-1609092943]={
{effect="cast0_eff1",effect_pack="d7005003",delay=1000,time=1500,path_index=0,type=0,pos_ref={ref_type=6},path_target={ref_type=1}},
