...
{effect="cast2_eff",time=6000,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/thrid.acb",cue_name="queenbee_attack_skill_02"},
{effect="cast2_hit",time=6000,type=0,pos_ref={ref_type=1}},
...
{effect="cast1_eff",time=3000,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/thrid.acb",cue_name="queenbee_attack_skill_01"},
...
[-1609092943]={
{effect="cast0_eff",time=1800,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/thrid.acb",cue_name="queenbee_attack_general"},
