...
{
[1310282141]={
{effect="cast2_eff",time=4210,type=0,pos_ref={ref_type=6}},
...
[-686817241]={
{effect="cast1_eff",time=3500,type=0,pos_ref={ref_type=6},cue_sheet="cv/pyroxene.acb",cue_name="pyroxene_10",cue_feature=1},
...
[-1609092943]={
{effect="cast0_eff",time=2400,type=0,pos_ref={ref_type=0,offset_row=90},cue_sheet="cv/pyroxene.acb",cue_name="pyroxene_09",cue_feature=1},
...
[661633433]={
effect="cast0_hit",time=2000,type=0,pos_ref={ref_type=4,offset_row=25,offset_height=-50,part_index=0}
}
};
