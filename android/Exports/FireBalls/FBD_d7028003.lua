...
{effect="cast2_eff",effect_pack="d70280",time=9000,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/eleventh.acb",cue_name="Gondul_attack_skill_02"}
},
[2124325257]={
effect="cast2_hit",effect_pack="d70280",time=2000,type=0,pos_ref={ref_type=4,part_index=1}
},
[-686817241]={
{delay=2800,time=1000,type=1,hit_type=1,camera_shake={time=400,shake_dir=1,range=200,hz=150,decay_value=0.4},hits={0}},
{effect="cast1_hit",effect_pack="d70280",time=6000,type=0,pos_ref={ref_type=5,offset_row=50,offset_col=-50}},
{time=3000,type=0,cue_sheet="fight/effect/eleventh.acb",cue_name="Gondul_attack_skill_01"},
{effect="cast1_eff",effect_pack="d70280",time=1500,type=0,pos_ref={ref_type=6}},
...
[-1609092943]={
{effect="cast0_eff",effect_pack="d70280",time=2000,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/eleventh.acb",cue_name="Gondul_attack_general"},
...
[-838067028]={
effect="cast0_hit",effect_pack="d70280",time=2000,type=0,pos_ref={ref_type=1}
},
[-1183793042]={
{effect="enter",effect_pack="d70280",time=3000,type=0,pos_ref={ref_type=6}}
}
};
