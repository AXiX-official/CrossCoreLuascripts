...
[1079508512]={
{effect="change_eff",effect_pack="d70051",time=2000,type=0,pos_ref={ref_type=6},cue_sheet="cv/Hades.acb",cue_name="Hades_12",cue_feature=1}
},
[1310282141]={
...
{effect="cast2_eff1",effect_pack="d70051",time=6500,type=0,pos_ref={ref_type=6},cue_sheet="cv/Hades.acb",cue_name="Hades_11",cue_feature=1},
...
{effect="cast0_hit1",effect_pack="d70051",delay=1000,time=3500,type=0,pos_ref={ref_type=0,offset_row=-150,lock_col=1}},
