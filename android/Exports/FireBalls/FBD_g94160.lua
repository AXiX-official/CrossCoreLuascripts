...
{delay=800,time=2000,type=1,hit_type=1,camera_shake={time=500,shake_dir=1,range=120,range1=300,range2=25,hz=30,decay_value=0.3},hit_creates={-838067028},hits={0}}
},
[-838067028]={
effect="cast0_hit",time=3000,type=0,pos_ref={ref_type=4,part_index=1},cue_sheet="fight/effect/seventh.acb",cue_name="Frost_guard_attack_general"
},
[-316323548]={
