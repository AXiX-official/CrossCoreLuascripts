...
{effect="cast1_hit",time=4000,type=0,pos_ref={ref_type=1,offset_row=-150,offset_col=100}},
{effect="cast1_eff",time=3500,type=0,pos_ref={ref_type=6},cue_sheet="cv/Scorching.acb",cue_name="Scorching_10",cue_feature=1},
...
{effect="cast0_eff",time=3500,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/seventeen.acb",cue_name="Scorching_attack_general",path_target={ref_type=1}},
