...
{effect="cast1_eff",time=3500,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/fourteen.acb",cue_name="Trade_attack_skill_01",path_target={ref_type=3}},
{time=3500,type=0,cue_sheet="cv/Trade.acb",cue_name="Trade_10",cue_feature=1},
{effect="cast1_hit",time=3500,type=0,pos_ref={ref_type=3}}
},
[-646510353]={
time=2000,type=0
},
...
{effect="cast2_eff",time=8000,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/fourteen.acb",cue_name="Trade_attack_skill_02"},
...
{effect="cast0_eff",time=3500,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/fourteen.acb",cue_name="Trade_attack_general"},
