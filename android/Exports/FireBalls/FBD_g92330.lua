...
{effect="cast2_hit",time=6000,type=0,pos_ref={ref_type=3,offset_row=125}}
},
[-686817241]={
...
{effect="cast1_eff",time=4500,type=0,pos_ref={ref_type=6},cue_sheet="fight/effect/twelfth.acb",cue_name="Mf_strength_attack_skill_01"},
