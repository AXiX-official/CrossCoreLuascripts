...
{effect="cast0_hit",time=2000,type=0,pos_ref={ref_type=0,offset_row=-100}},
{delay=650,time=2000,type=1,hit_type=1,camera_shake={time=500,shake_dir=1,range=200,range1=400,range2=25,hz=30,decay_value=0.3},hits={0}},
