...
monsters=
{
{id=101051,born_group=100,wave=1},
{id=101051,born_group=100,wave=1},
{id=101052,born_group=104,wave=2},
{id=101054,born_group=102,wave=3}
},
props=
{
...
{born_pos=10505,wave=1,rate=100,nPropID=4,offset_x=-300,offset_y=-100,offset_z=100,float_content="HP-20%",shake_delay=0,shake_time=705,shake_range=100,icon="图标名称",desc="红蓝炮塔",res="GridProps/paotai/paotai",bIsCanPass=1,perpetual=1,nStep=2,state=4,type=30,param={0.1},attackType=1,damage=0.2,ranges={106,107,108}}
},
}
return this;