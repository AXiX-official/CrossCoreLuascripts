...
monsters=
{
{id=201251,born_group=101,wave=1},
{id=201252,born_group=101,wave=1},
{id=201252,born_group=104,wave=2},
{id=201253,born_group=104,wave=2},
{id=201254,born_group=102,wave=3}
},
props=
{
...
{born_pos=10401,wave=2,rate=100,nPropID=4,float_content="NP+50",use_sound="ui_buff_attack",name="NP补给",icon="MapProps_003",desc="基地投送的作战补给，获得后队伍NP+50。",res="GridProps/buff/Buff_NP",get_eff="get_eff_green",eBlockState=1,nStep=0,state=1,type=34,param={0.1},nNp=50}
},
}
return this;