...
monsters=
{
{id=201191,born_group=101,wave=1},
{id=201191,born_group=101,wave=1},
{id=201192,born_group=104,wave=2},
{id=201193,born_group=104,wave=2},
{id=201194,born_group=102,wave=3}
},
props=
{
...
{born_group=103,wave=2,rate=75,nPropID=2,name="货箱",icon="MapProps_001",desc="装着各种随机素材的箱子。",res="GridProps/baoxiang/baoxiang",get_eff="baoxiang_hit",eBlockState=1,nStep=0,state=1,type=28,param={10001}},
...
{born_pos=10701,wave=1,rate=100,nPropID=6,float_content="HP-10%",shake_delay=0,shake_time=705,shake_range=100,name="预示落雷A",desc="宙斯元素落雷",perpetual=1,nStep=1,state=1,type=32,isLoop=1,damage=0.09999999,ranges={107,108,109},bufferID=5907}
},
}
return this;