...
monsters=
{
{id=201121,born_group=101,wave=1},
{id=201121,born_group=101,wave=1},
{id=201122,born_pos=10603,wave=2},
{id=201123,born_pos=10206,wave=2},
{id=201124,born_pos=10303,wave=3}
},
props=
{
...
{born_pos=10601,wave=3,rate=100,nPropID=3,float_content="HP+50%",use_sound="ui_buff_attack",name="生命补给",icon="MapProps_002",desc="基地投送的作战补给，获得后队伍全体生命+50%。",res="GridProps/buff/Buff_Heal",get_eff="get_eff_green",eBlockState=1,nStep=0,state=1,type=2,param={0.5}},
