...
{born_group=105,wave=3,rate=100,nPropID=2,float_content="耐久+50%",use_sound="ui_buff_attack",name="生命补给",icon="图标名称",desc="基地投送的作战补给，获得后队伍全体耐久+50%。",res="GridProps/buff/Buff_Heal",get_eff="get_eff_green",eBlockState=1,nStep=0,state=1,type=2,param={0.5}}
},
}
return this;