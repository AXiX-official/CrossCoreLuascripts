...
---------------------------------------------
-- 技能基类
Buffer319501 = oo.class(BuffBase)
function Buffer319501:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer319501:OnRoundBegin(caster, target)
	-- 8060
	...
	-- 319501
	self:LimitDamage(BufferEffect[319501], self.caster, target or self.owner, nil,1,0.1)
	-- 6115
	self:ImmuneBuffID(BufferEffect[6115], self.caster, target or self.owner, nil,3006)
end
-- 创建时
function Buffer319501:OnCreate(caster, target)
	-- 8063
