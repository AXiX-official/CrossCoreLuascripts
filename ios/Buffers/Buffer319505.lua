...
---------------------------------------------
-- 技能基类
Buffer319505 = oo.class(BuffBase)
function Buffer319505:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer319505:OnRoundBegin(caster, target)
	-- 8060
	...
	-- 319505
	self:LimitDamage(BufferEffect[319505], self.caster, target or self.owner, nil,1,0.5)
	-- 6115
	self:ImmuneBuffID(BufferEffect[6115], self.caster, target or self.owner, nil,3006)
end
-- 创建时
function Buffer319505:OnCreate(caster, target)
	-- 8063
