...
---------------------------------------------
-- 技能基类
Buffer319502 = oo.class(BuffBase)
function Buffer319502:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer319502:OnRoundBegin(caster, target)
	-- 8060
	...
	-- 319502
	self:LimitDamage(BufferEffect[319502], self.caster, target or self.owner, nil,1,0.2)
	-- 6115
	self:ImmuneBuffID(BufferEffect[6115], self.caster, target or self.owner, nil,3006)
end
-- 创建时
function Buffer319502:OnCreate(caster, target)
	-- 8063
