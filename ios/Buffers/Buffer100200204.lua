...
---------------------------------------------
-- 技能基类
Buffer100200204 = oo.class(BuffBase)
function Buffer100200204:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 死亡时
function Buffer100200204:OnDeath(caster, target)
	-- 8070
...
-- 行动结束
function Buffer100200204:OnActionOver(caster, target)
	-- 8063
	...
	-- 100200204
	self:AddHp(BufferEffect[100200204], self.caster, self.card, nil, math.floor(c14*0.65))
end
