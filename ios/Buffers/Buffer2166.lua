...
---------------------------------------------
-- 技能基类
Buffer2166 = oo.class(BuffBase)
function Buffer2166:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 移除buff时
function Buffer2166:OnRemoveBuff(caster, target)
	-- 8446
...
-- 创建时
function Buffer2166:OnCreate(caster, target)
	-- 2126
