...
---------------------------------------------
-- 技能基类
Buffer319504 = oo.class(BuffBase)
function Buffer319504:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 回合开始时
function Buffer319504:OnRoundBegin(caster, target)
	-- 8060
	...
	-- 319504
	self:LimitDamage(BufferEffect[319504], self.caster, target or self.owner, nil,1,0.4)
	-- 6115
	self:ImmuneBuffID(BufferEffect[6115], self.caster, target or self.owner, nil,3006)
end
-- 创建时
function Buffer319504:OnCreate(caster, target)
	-- 8063
