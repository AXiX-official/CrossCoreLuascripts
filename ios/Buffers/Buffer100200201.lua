...
---------------------------------------------
-- 技能基类
Buffer100200201 = oo.class(BuffBase)
function Buffer100200201:Init(mgr, id, target, caster)
	BuffBase.Init(self, mgr, id, target, caster)
end
-- 死亡时
function Buffer100200201:OnDeath(caster, target)
	-- 8070
...
-- 行动结束
function Buffer100200201:OnActionOver(caster, target)
	-- 8063
	...
	-- 100200201
	self:AddHp(BufferEffect[100200201], self.caster, self.card, nil, math.floor(c14*0.50))
end
