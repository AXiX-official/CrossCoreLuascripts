...
---------------------------------------------
-- 技能基类
Skill4500604 = oo.class(SkillBase)
function Skill4500604:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill4500604:OnRoundOver(caster, target, data)
	-- 8060
	...
	-- 4500604
	self:AddBuff(SkillEffect[4500604], caster, self.card, data, 4500604)
	-- 4500606
