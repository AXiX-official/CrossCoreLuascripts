...
---------------------------------------------
-- 技能基类
Skill913100302 = oo.class(SkillBase)
function Skill913100302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill913100302:DoSkill(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill913100302:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 回合开始处理完成后
function Skill913100302:OnAfterRoundBegin(caster, target, data)
	-- 8841
...
-- 攻击结束
function Skill913100302:OnAttackOver(caster, target, data)
	-- 8063
...
-- 入场时
function Skill913100302:OnBorn(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
