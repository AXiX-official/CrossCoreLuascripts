...
---------------------------------------------
-- 技能基类
Skill200700202 = oo.class(SkillBase)
function Skill200700202:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill200700202:OnActionOver(caster, target, data)
	-- 8063
...
-- 伤害后
function Skill200700202:OnAfterHurt(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	...
	-- 200700212
	self:AddEnergy(SkillEffect[200700212], caster, self.card, data, count21*0.25,1)
end
