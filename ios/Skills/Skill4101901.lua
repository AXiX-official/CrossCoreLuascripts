...
---------------------------------------------
-- 技能基类
Skill4101901 = oo.class(SkillBase)
function Skill4101901:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4101901:OnBorn(caster, target, data)
	-- 8060
	...
	-- 4101901
	self:SetShareDamage(SkillEffect[4101901], caster, self.card, data, 0.2)
end
-- 伤害后
function Skill4101901:OnAfterHurt(caster, target, data)
	-- 8063
...
-- 行动结束
function Skill4101901:OnActionOver(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
