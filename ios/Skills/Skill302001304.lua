...
---------------------------------------------
-- 技能基类
Skill302001304 = oo.class(SkillBase)
function Skill302001304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill302001304:DoSkill(caster, target, data)
	-- 11004
...
-- 伤害前
function Skill302001304:OnBefourHurt(caster, target, data)
	-- 8060
