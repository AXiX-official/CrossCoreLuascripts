...
---------------------------------------------
-- 技能基类
Skill4200703 = oo.class(SkillBase)
function Skill4200703:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 死亡时
function Skill4200703:OnDeath(caster, target, data)
	-- 8254
	...
	-- 4200703
	self:PassiveRevive(SkillEffect[4200703], caster, target, data, 2,0.6,{progress=600})
	-- 4200713
...
-- 行动开始
function Skill4200703:OnActionBegin(caster, target, data)
	-- 8063
...
-- 入场时
function Skill4200703:OnBorn(caster, target, data)
	-- 8060
