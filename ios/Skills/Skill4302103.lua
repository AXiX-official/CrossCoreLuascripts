...
function Skill4302103:tFunc_8381_8314(caster, target, data)
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	end
...
function Skill4302103:tFunc_8383_8353(caster, target, data)
...
function Skill4302103:tFunc_8382_8373(caster, target, data)
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
	end
...
function Skill4302103:tFunc_8383_8352(caster, target, data)
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
	end
...
function Skill4302103:tFunc_8381_8315(caster, target, data)
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	end
...
function Skill4302103:tFunc_8382_8372(caster, target, data)
	if SkillJudger:TargetIsSelf(self, caster, target, true) then
	else
		return
	end
