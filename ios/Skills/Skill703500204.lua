...
---------------------------------------------
-- 技能基类
Skill703500204 = oo.class(SkillBase)
function Skill703500204:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill703500204:DoSkill(caster, target, data)
	-- 12004
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 伤害后
function Skill703500204:OnAfterHurt(caster, target, data)
	-- 8060
