...
---------------------------------------------
-- 技能基类
Skill22902 = oo.class(SkillBase)
function Skill22902:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill22902:OnActionOver(caster, target, data)
	-- 8063
	...
	-- 22902
	self:AddBuff(SkillEffect[22902], caster, caster, data, 302301)
	-- 22912
