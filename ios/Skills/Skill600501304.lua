...
---------------------------------------------
-- 技能基类
Skill600501304 = oo.class(SkillBase)
function Skill600501304:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600501304:DoSkill(caster, target, data)
	-- 11111
...
-- 行动开始
function Skill600501304:OnActionBegin(caster, target, data)
	-- 8060
...
-- 行动结束2
function Skill600501304:OnActionOver2(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
-- 加buff时
function Skill600501304:OnAddBuff(caster, target, data, buffer)
	-- 8063
