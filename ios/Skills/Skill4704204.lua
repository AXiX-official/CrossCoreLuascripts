...
---------------------------------------------
-- 技能基类
Skill4704204 = oo.class(SkillBase)
function Skill4704204:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4704204:OnBorn(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill4704204:OnActionOver(caster, target, data)
	-- 4704224
	self:tFunc_4704224_4704204(caster, target, data)
	self:tFunc_4704224_4704214(caster, target, data)
end
-- 伤害前
function Skill4704204:OnBefourHurt(caster, target, data)
	-- 4704234
	self:AddTempAttr(SkillEffect[4704234], caster, self.card, data, "damage",0.25)
end
function Skill4704204:tFunc_4704224_4704214(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4704204:tFunc_4704224_4704204(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
