...
---------------------------------------------
-- 技能基类
Skill4300204 = oo.class(SkillBase)
function Skill4300204:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill4300204:OnAttackOver(caster, target, data)
	-- 8060
	...
	-- 4300204
	self:LimitDamage(SkillEffect[4300204], caster, target, data, 1,0.5)
	-- 4300207
