...
---------------------------------------------
-- 技能基类
Skill4500605 = oo.class(SkillBase)
function Skill4500605:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill4500605:OnRoundOver(caster, target, data)
	-- 8060
	...
	-- 4500605
	self:AddBuff(SkillEffect[4500605], caster, self.card, data, 4500605)
	-- 4500606
