...
---------------------------------------------
-- 技能基类
Skill302001309 = oo.class(SkillBase)
function Skill302001309:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill302001309:DoSkill(caster, target, data)
...
-- 伤害前
function Skill302001309:OnBefourHurt(caster, target, data)
