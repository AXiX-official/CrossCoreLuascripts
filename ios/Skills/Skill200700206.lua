...
---------------------------------------------
-- 技能基类
Skill200700206 = oo.class(SkillBase)
function Skill200700206:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill200700206:DoSkill(caster, target, data)
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12001], caster, target, data, 1,1)
end
-- 行动结束
function Skill200700206:OnActionOver(caster, target, data)
