...
---------------------------------------------
-- 技能基类
Skill336101 = oo.class(SkillBase)
function Skill336101:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合开始时
function Skill336101:OnRoundBegin(caster, target, data)
	-- 8062
	...
	if self:Rand(1000) then
		self:DelBufferGroup(SkillEffect[336101], caster, caster, data, 2,2)
		-- 336111
