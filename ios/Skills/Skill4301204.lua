...
---------------------------------------------
-- 技能基类
Skill4301204 = oo.class(SkillBase)
function Skill4301204:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill4301204:OnActionOver(caster, target, data)
	-- 8063
	...
	-- 4301204
	self:OwnerAddBuffCount(SkillEffect[4301204], caster, self.card, data, 4301204,1,5)
	-- 4301206
