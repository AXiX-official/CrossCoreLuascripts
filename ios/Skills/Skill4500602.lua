...
---------------------------------------------
-- 技能基类
Skill4500602 = oo.class(SkillBase)
function Skill4500602:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合结束时
function Skill4500602:OnRoundOver(caster, target, data)
	-- 8060
	...
	-- 4500602
	self:AddBuff(SkillEffect[4500602], caster, self.card, data, 4500602)
	-- 4500606
