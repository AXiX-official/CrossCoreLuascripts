...
---------------------------------------------
-- 技能基类
Skill321203 = oo.class(SkillBase)
function Skill321203:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill321203:OnAfterHurt(caster, target, data)
	-- 8071
	...
	-- 321203
	self:AddHp(SkillEffect[321203], caster, caster, data, -count21*0.3)
end
