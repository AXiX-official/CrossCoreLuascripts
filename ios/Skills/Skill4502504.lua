...
-- 回合结束时
function Skill4502504:OnRoundOver(caster, target, data)
	-- 8237
	...
	for i,target in ipairs(targets) do
		self:CallOwnerSkill(SkillEffect[4502504], caster, target, data, 502500404)
	end
end
-- 伤害前
...
-- 回合开始时
function Skill4502504:OnRoundBegin(caster, target, data)
	-- 8237
	if SkillJudger:IsCasterMech(self, caster, self.card, true,5) then
	else
		return
	...
	-- 4502524
	self:AddBuff(SkillEffect[4502524], caster, caster, data, 4502514)
end
