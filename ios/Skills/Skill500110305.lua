...
---------------------------------------------
-- 技能基类
Skill500110305 = oo.class(SkillBase)
function Skill500110305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill500110305:DoSkill(caster, target, data)
	-- 12801
...
-- 攻击结束
function Skill500110305:OnAttackOver(caster, target, data)
	-- 8060
