...
---------------------------------------------
-- 技能基类
Skill500300202 = oo.class(SkillBase)
function Skill500300202:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill500300202:DoSkill(caster, target, data)
	-- 12201
...
-- 行动结束
function Skill500300202:OnActionOver(caster, target, data)
	-- 8326
