...
---------------------------------------------
-- 技能基类
Skill332602 = oo.class(SkillBase)
function Skill332602:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill332602:OnBefourHurt(caster, target, data)
	-- 8063
...
-- 伤害后
function Skill332602:OnAfterHurt(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	...
	-- 332602
	self:AddBuffCount(SkillEffect[332602], caster, self.card, data, 332602,1,5)
end
-- 行动结束2
function Skill332602:OnActionOver2(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
