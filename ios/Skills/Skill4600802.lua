...
---------------------------------------------
-- 技能基类
Skill4600802 = oo.class(SkillBase)
function Skill4600802:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4600802:OnBorn(caster, target, data)
	-- 4600806
	self:AddBuff(SkillEffect[4600806], caster, self.card, data, 6111)
end
-- 行动结束2
function Skill4600802:OnActionOver2(caster, target, data)
	-- 8063
	...
	-- 4600802
	self:Cure(SkillEffect[4600802], caster, self.card, data, 2,0.15)
	-- 92017
