...
-- 行动结束2
function Skill4300405:OnActionOver2(caster, target, data)
	-- 8679
	...
	-- 4300405
	self:AddProgress(SkillEffect[4300405], caster, self.card, data, 600)
	-- 4300416
	...
	-- 4300415
	self:AddBuff(SkillEffect[4300415], caster, self.card, data, 4004,1)
	-- 4300417
