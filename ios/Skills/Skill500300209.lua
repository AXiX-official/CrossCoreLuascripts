...
---------------------------------------------
-- 技能基类
Skill500300209 = oo.class(SkillBase)
function Skill500300209:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill500300209:DoSkill(caster, target, data)
...
-- 行动结束
function Skill500300209:OnActionOver(caster, target, data)
