...
---------------------------------------------
-- 技能基类
Skill1100010232 = oo.class(SkillBase)
function Skill1100010232:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill1100010232:OnActionOver(caster, target, data)
	-- 8063
	...
	if self:Rand(5000) then
		self:AddBuff(SkillEffect[1100010232], caster, caster, data, 302301)
		-- 22913
