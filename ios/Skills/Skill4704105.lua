...
---------------------------------------------
-- 技能基类
Skill4704105 = oo.class(SkillBase)
function Skill4704105:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4704105:OnBorn(caster, target, data)
	-- 8060
...
-- 回合开始时
function Skill4704105:OnRoundBegin(caster, target, data)
	-- 8062
...
-- 伤害后
function Skill4704105:OnAfterHurt(caster, target, data)
	-- 8063
