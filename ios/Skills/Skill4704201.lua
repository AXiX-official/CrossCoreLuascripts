...
---------------------------------------------
-- 技能基类
Skill4704201 = oo.class(SkillBase)
function Skill4704201:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4704201:OnBorn(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill4704201:OnActionOver(caster, target, data)
	-- 4704221
	self:tFunc_4704221_4704201(caster, target, data)
	self:tFunc_4704221_4704211(caster, target, data)
end
-- 伤害前
function Skill4704201:OnBefourHurt(caster, target, data)
	-- 4704231
	self:AddTempAttr(SkillEffect[4704231], caster, self.card, data, "damage",0.10)
end
function Skill4704201:tFunc_4704221_4704201(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill4704201:tFunc_4704221_4704211(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
