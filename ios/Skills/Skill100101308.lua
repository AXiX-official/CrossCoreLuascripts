...
---------------------------------------------
-- 技能基类
Skill100101308 = oo.class(SkillBase)
function Skill100101308:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100101308:DoSkill(caster, target, data)
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12004], caster, target, data, 0.25,4)
end
-- 行动结束
function Skill100101308:OnActionOver(caster, target, data)
