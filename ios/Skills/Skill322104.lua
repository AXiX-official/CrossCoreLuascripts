...
---------------------------------------------
-- 技能基类
Skill322104 = oo.class(SkillBase)
function Skill322104:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill322104:OnBefourHurt(caster, target, data)
	-- 8060
	...
	-- 322104
	self:AddTempAttr(SkillEffect[322104], caster, self.card, data, "damage",0.40)
end
