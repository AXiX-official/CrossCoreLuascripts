...
---------------------------------------------
-- 技能基类
Skill322101 = oo.class(SkillBase)
function Skill322101:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害前
function Skill322101:OnBefourHurt(caster, target, data)
	-- 8060
	...
	-- 322101
	self:AddTempAttr(SkillEffect[322101], caster, self.card, data, "damage",0.10)
end
