...
---------------------------------------------
-- 技能基类
Skill700701309 = oo.class(SkillBase)
function Skill700701309:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill700701309:DoSkill(caster, target, data)
...
-- 行动结束
function Skill700701309:OnActionOver(caster, target, data)
...
-- 伤害前
function Skill700701309:OnBefourHurt(caster, target, data)
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	end
