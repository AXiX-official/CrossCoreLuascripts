...
---------------------------------------------
-- 技能基类
Skill4401504 = oo.class(SkillBase)
function Skill4401504:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束2
function Skill4401504:OnActionOver2(caster, target, data)
	-- 8063
	...
	-- 4401504
	self:BeatBack(SkillEffect[4401504], caster, self.card, data, 401500404,5)
end
