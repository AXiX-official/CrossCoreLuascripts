...
---------------------------------------------
-- 技能基类
Skill304901305 = oo.class(SkillBase)
function Skill304901305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill304901305:DoSkill(caster, target, data)
	-- 11006
...
-- 行动开始
function Skill304901305:OnActionBegin(caster, target, data)
	-- 8060
...
function Skill304901305:OnBefourCritHurt(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
