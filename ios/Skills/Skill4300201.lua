...
---------------------------------------------
-- 技能基类
Skill4300201 = oo.class(SkillBase)
function Skill4300201:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill4300201:OnAttackOver(caster, target, data)
	-- 8060
	...
	-- 4300201
	self:LimitDamage(SkillEffect[4300201], caster, target, data, 1,0.2)
	-- 4300207
