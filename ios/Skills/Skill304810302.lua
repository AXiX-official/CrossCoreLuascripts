...
---------------------------------------------
-- 技能基类
Skill304810302 = oo.class(SkillBase)
function Skill304810302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill304810302:DoSkill(caster, target, data)
	-- 11008
	self.order = self.order + 1
	self:DamagePhysics(SkillEffect[11008], caster, target, data, 0.125,8)
end
-- 暴击伤害前(OnBefourHurt之前)
function Skill304810302:OnBefourCritHurt(caster, target, data)
	-- 8060
