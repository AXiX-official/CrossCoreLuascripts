...
---------------------------------------------
-- 技能基类
Skill200700201 = oo.class(SkillBase)
function Skill200700201:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 行动结束
function Skill200700201:OnActionOver(caster, target, data)
	-- 8063
...
-- 伤害后
function Skill200700201:OnAfterHurt(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	...
	-- 200700211
	self:AddEnergy(SkillEffect[200700211], caster, self.card, data, count21*0.2,1)
end
