...
---------------------------------------------
-- 技能基类
Skill329804 = oo.class(SkillBase)
function Skill329804:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 回合开始时
function Skill329804:OnRoundBegin(caster, target, data)
	-- 8063
	...
	if self:Rand(4500) then
		...
		for i,target in ipairs(targets) do
			self:SpreadBuff(SkillEffect[329804], caster, target, data, 3,1002)
		end
	end
end
