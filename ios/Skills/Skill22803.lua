...
---------------------------------------------
-- 技能基类
Skill22803 = oo.class(SkillBase)
function Skill22803:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill22803:OnBorn(caster, target, data)
	-- 4600806
	self:AddBuff(SkillEffect[4600806], caster, self.card, data, 6111)
end
-- 行动结束
function Skill22803:OnActionOver(caster, target, data)
	-- 8063
...
-- 回合开始处理完成后
function Skill22803:OnAfterRoundBegin(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
