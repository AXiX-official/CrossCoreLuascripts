...
---------------------------------------------
-- 技能基类
Skill600300302 = oo.class(SkillBase)
function Skill600300302:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600300302:DoSkill(caster, target, data)
	-- 12005
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12005], caster, target, data, 0.2,5)
end
-- 入场时
function Skill600300302:OnBorn(caster, target, data)
	-- 4600306
