...
---------------------------------------------
-- 技能基类
Skill301800303 = oo.class(SkillBase)
function Skill301800303:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill301800303:DoSkill(caster, target, data)
	-- 11081
...
-- 伤害前
function Skill301800303:OnBefourHurt(caster, target, data)
	-- 8060
