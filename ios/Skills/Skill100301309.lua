...
---------------------------------------------
-- 技能基类
Skill100301309 = oo.class(SkillBase)
function Skill100301309:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100301309:DoSkill(caster, target, data)
...
-- 行动结束
function Skill100301309:OnActionOver(caster, target, data)
