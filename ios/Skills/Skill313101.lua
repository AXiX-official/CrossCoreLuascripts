...
---------------------------------------------
-- 技能基类
Skill313101 = oo.class(SkillBase)
function Skill313101:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill313101:OnBorn(caster, target, data)
	-- 8381
	self:tFunc_8381_8371(caster, target, data)
	self:tFunc_8381_8314(caster, target, data)
	self:tFunc_8381_8315(caster, target, data)
end
function Skill313101:tFunc_8381_8371(caster, target, data)
	-- 8060
...
function Skill313101:tFunc_8381_8314(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
...
function Skill313101:tFunc_8381_8315(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
