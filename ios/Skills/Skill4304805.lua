...
---------------------------------------------
-- 技能基类
Skill4304805 = oo.class(SkillBase)
function Skill4304805:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 入场时
function Skill4304805:OnBorn(caster, target, data)
	-- 8060
...
-- 攻击结束
function Skill4304805:OnAttackOver(caster, target, data)
	-- 8063
