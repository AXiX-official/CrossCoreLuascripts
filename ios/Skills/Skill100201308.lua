...
---------------------------------------------
-- 技能基类
Skill100201308 = oo.class(SkillBase)
function Skill100201308:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill100201308:DoSkill(caster, target, data)
...
-- 行动结束
function Skill100201308:OnActionOver(caster, target, data)
...
-- 死亡时
function Skill100201308:OnDeath(caster, target, data)
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
	end
