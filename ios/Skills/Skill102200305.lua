...
---------------------------------------------
-- 技能基类
Skill102200305 = oo.class(SkillBase)
function Skill102200305:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill102200305:DoSkill(caster, target, data)
	-- 102200301
	self.order = self.order + 1
	self:OwnerAddBuffCount(SkillEffect[102200301], caster, target, data, 102200301,3,6)
end
-- 回合结束时
function Skill102200305:OnRoundOver(caster, target, data)
	-- 8712
...
-- 死亡时
function Skill102200305:OnDeath(caster, target, data)
	-- 8070
