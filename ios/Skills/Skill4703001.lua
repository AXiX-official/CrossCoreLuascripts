...
---------------------------------------------
-- 技能基类
Skill4703001 = oo.class(SkillBase)
function Skill4703001:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 伤害后
function Skill4703001:OnAfterHurt(caster, target, data)
	-- 8063
...
-- 入场时
function Skill4703001:OnBorn(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill4703001:OnActionOver(caster, target, data)
	-- 8060
	if SkillJudger:CasterIsSelf(self, caster, target, true) then
	else
		return
