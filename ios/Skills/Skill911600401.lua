...
---------------------------------------------
-- 技能基类
Skill911600401 = oo.class(SkillBase)
function Skill911600401:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill911600401:DoSkill(caster, target, data)
	-- 12001
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12001], caster, target, data, 1,1)
end
-- 攻击结束
function Skill911600401:OnAttackOver(caster, target, data)
	-- 8063
...
-- 伤害前
function Skill911600401:OnBefourHurt(caster, target, data)
	-- 8060
...
-- 行动结束
function Skill911600401:OnActionOver(caster, target, data)
	-- 8063
	if SkillJudger:CasterIsEnemy(self, caster, target, true) then
	else
		return
	...
	-- 911600403
	self:BeatBack(SkillEffect[911600403], caster, target, data, 910800201)
	-- 907700404
