...
---------------------------------------------
-- 技能基类
Skill503200205 = oo.class(SkillBase)
function Skill503200205:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill503200205:DoSkill(caster, target, data)
	-- 12811
...
-- 攻击结束
function Skill503200205:OnAttackOver(caster, target, data)
	-- 8060
