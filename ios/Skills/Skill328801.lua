...
---------------------------------------------
-- 技能基类
Skill328801 = oo.class(SkillBase)
function Skill328801:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 攻击结束
function Skill328801:OnAttackOver(caster, target, data)
	-- 8063
	...
	-- 328801
	self:AddBuff(SkillEffect[328801], caster, caster, data, 328801)
end
