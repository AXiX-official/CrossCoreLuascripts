...
---------------------------------------------
-- 技能基类
Skill600300301 = oo.class(SkillBase)
function Skill600300301:Init(skillID, card)
	SkillBase.Init(self, skillID, card)
end
-- 执行技能
function Skill600300301:DoSkill(caster, target, data)
	-- 12005
	self.order = self.order + 1
	self:DamageLight(SkillEffect[12005], caster, target, data, 0.2,5)
end
-- 入场时
function Skill600300301:OnBorn(caster, target, data)
	-- 4600306
	self:AddBuff(SkillEffect[4600306], caster, self.card, data, 6111)
end
-- 行动结束2
function Skill600300301:OnActionOver2(caster, target, data)
	-- 8063
