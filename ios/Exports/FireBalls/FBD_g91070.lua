...
{
[-1183793042]={
{delay=500,time=2000,type=0}
},
[1310282141]={
{time=4000,type=0,cue_sheet="fight/effect/seventh.acb",cue_name="Frost_guard_attack_skill_02"},
{effect="cast2_eff",time=4500,type=0,pos_ref={ref_type=6,offset_row=-339,lock_col=1}},
...
{effect="cast1_hit2",delay=1500,time=4000,type=0,pos_ref={ref_type=1,offset_row=100,lock_col=1}},
{time=4000,type=0,cue_sheet="fight/effect/seventh.acb",cue_name="Frost_guard_attack_skill_01"},
{effect="cast1_hit1",delay=1400,time=4000,type=0,pos_ref={ref_type=1,offset_row=100,lock_col=1}}
},
[-1609092943]={
{effect="cast0_eff",time=3000,type=0,pos_ref={ref_type=6},path_target={ref_type=1}},
{delay=450,time=2000,type=1,hit_type=1,camera_shake={time=500,shake_dir=1,range=200,range1=400,range2=25,hz=30,decay_value=0.3},hit_creates={661633433},hits={0}},
