...
{
[2008187309]={
{effect="change_eff",time=2000,type=0,pos_ref={ref_type=6}}
},
[1079508512]={
...
[1310282141]={
{effect="cast2_eff",time=6000,type=0,pos_ref={ref_type=6},cue_sheet="cv/Hades.acb",cue_name="Hades_10",cue_feature=1},
...
[-1609092943]={
{effect="cast0_eff",time=4000,type=0,pos_ref={ref_type=6},cue_sheet="cv/Hades.acb",cue_name="Hades_09",cue_feature=1},
{effect="cast0_hit",delay=1600,time=5000,type=0,pos_ref={ref_type=1}},
{effect="cast0_eff1",delay=1000,time=1500,path_index=0,type=0,pos_ref={ref_type=6},path_target={ref_type=1}},
