...
cast1={play_time=3500,feature=1,feature_camera_no_transform=1,last_hit=2800,hide_buff=1},
cast0={play_time=3333,start_pos={ref_type=0,offset_row=-200,lock_col=1},last_hit=1870,hide_buff=1},
dead={play_time=2833,hide_buff=1}
};
