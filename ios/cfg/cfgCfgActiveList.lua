local conf = {
	...
	["sheetname"] = '活动列表',
	["types"] = {
'int','string','int','int','int','int','string','string','string','string','json','string','int','json','string','int[]','int','int'
},
	["names"] = {
'id','key','type','specType','group','index','data','sTime','eTime','cTime','leftInfo','path','taskType','info','moduleInfo','time','timeType','bIsShow'
},
	["data"] = {
{'1001',	'1001',	'1001',	'2',	'1',	'401',	'',	'',	'',	'',	'[{"id":22003,"path":"ActivityList/icon1"}]',	'SignIn/SignInView',	'',	'',	'',	'',	'',	'1'},
...
{'1015',	'1015',	'1015',	'1',	'1',	'306',	'',	'2024-12-11 10:00:00',	'2024-12-25 03:00:00',	'',	'[{"id":22062,"path":"ActivityList/icon8"}]',	'SignInContinue7/SignInGift',	'',	'{"signInId":5001,"PaySignTime":15}',	'',	'',	'',	''},
