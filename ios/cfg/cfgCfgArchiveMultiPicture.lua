local conf = {
	...
	["sheetname"] = '多人插图',
	["types"] = {
'int','string','int','string','int','int','string','string','string','string','string','string','float[]','string','float[]','bool','int'
},
	["names"] = {
'id','key','itemId','sName','sort','theme_type','sStart','sEnd','img','img_replace','icon','get_txt','imgPos','l2dName','l2dPos','show','shopId'
},
	["data"] = {
